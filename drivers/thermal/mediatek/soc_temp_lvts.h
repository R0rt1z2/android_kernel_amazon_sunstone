...
#define DEVICE_ACCESS_STATUS	BIT(24)
#define WRITE_ACCESS		BIT(16)
#define DEVICE_WRITE		(BIT(31) | CK26M_ACTIVE | DEVICE_ACCESS_STATUS \
				| BIT(17) | WRITE_ACCESS)
#define DEVICE_READ		(BIT(31) | CK26M_ACTIVE | DEVICE_ACCESS_STATUS \
				| 1 << 17)
