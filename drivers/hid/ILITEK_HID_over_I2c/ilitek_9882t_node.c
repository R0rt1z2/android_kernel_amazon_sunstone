...
#ifdef CONFIG_COMPAT
#define ILITEK_COMPAT_IOCTL_I2C_WRITE_DATA                                     \
	_IOWR(ILITEK_IOCTL_MAGIC, 0, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_I2C_SET_WRITE_LENGTH                               \
	_IOWR(ILITEK_IOCTL_MAGIC, 1, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_I2C_READ_DATA                                      \
	_IOWR(ILITEK_IOCTL_MAGIC, 2, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_I2C_SET_READ_LENGTH                                \
	_IOWR(ILITEK_IOCTL_MAGIC, 3, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_HW_RESET                                        \
	_IOWR(ILITEK_IOCTL_MAGIC, 4, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_POWER_SWITCH                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 5, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_REPORT_SWITCH                                   \
	_IOWR(ILITEK_IOCTL_MAGIC, 6, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_IRQ_SWITCH                                      \
	_IOWR(ILITEK_IOCTL_MAGIC, 7, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_DEBUG_LEVEL                                     \
	_IOWR(ILITEK_IOCTL_MAGIC, 8, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_FUNC_MODE                                       \
	_IOWR(ILITEK_IOCTL_MAGIC, 9, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_FW_VER                                          \
	_IOWR(ILITEK_IOCTL_MAGIC, 10, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_PL_VER                                          \
	_IOWR(ILITEK_IOCTL_MAGIC, 11, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_CORE_VER                                        \
	_IOWR(ILITEK_IOCTL_MAGIC, 12, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_DRV_VER                                         \
	_IOWR(ILITEK_IOCTL_MAGIC, 13, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_CHIP_ID                                         \
	_IOWR(ILITEK_IOCTL_MAGIC, 14, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_NETLINK_CTRL                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 15, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_NETLINK_STATUS                                  \
	_IOWR(ILITEK_IOCTL_MAGIC, 16, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_MODE_CTRL                                       \
	_IOWR(ILITEK_IOCTL_MAGIC, 17, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_MODE_STATUS                                     \
	_IOWR(ILITEK_IOCTL_MAGIC, 18, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_ICE_MODE_SWITCH                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 19, compat_uptr_t)

#define ILITEK_COMPAT_IOCTL_TP_INTERFACE_TYPE                                  \
	_IOWR(ILITEK_IOCTL_MAGIC, 20, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_DUMP_FLASH                                      \
	_IOWR(ILITEK_IOCTL_MAGIC, 21, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_FW_UART_CTRL                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 22, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_PANEL_INFO                                      \
	_IOWR(ILITEK_IOCTL_MAGIC, 23, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_TP_INFO _IOWR(ILITEK_IOCTL_MAGIC, 24, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_WRAPPER_RW                                         \
	_IOWR(ILITEK_IOCTL_MAGIC, 25, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_DDI_WRITE                                          \
	_IOWR(ILITEK_IOCTL_MAGIC, 26, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_DDI_READ                                           \
	_IOWR(ILITEK_IOCTL_MAGIC, 27, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_REPORT_RATE_SET                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 28, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_REPORT_RATE_GET                                    \
	_IOWR(ILITEK_IOCTL_MAGIC, 29, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_MP_LCM_OFF_ENV                                     \
	_IOWR(ILITEK_IOCTL_MAGIC, 30, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_RELEASE_TOUCH                                      \
	_IOWR(ILITEK_IOCTL_MAGIC, 31, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_LCM_STATUS                                         \
	_IOWR(ILITEK_IOCTL_MAGIC, 32, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_CLIENT_CTRL                                         \
	_IOWR(ILITEK_IOCTL_MAGIC, 33, compat_uptr_t)
#define ILITEK_COMPAT_IOCTL_CASCADE_REG_RW                                     \
	_IOWR(ILITEK_IOCTL_MAGIC, 34, compat_uptr_t)
...
int file_hid_write(struct file_buffer *file, bool new_open)
{
...
static int ilitek_debug_node_buff_control(bool open)
{
	...
	if (open) {
		...
		ilits->dbl = kzalloc(TR_BUF_LIST_SIZE * sizeof(*ilits->dbl),
				     GFP_KERNEL);
		...
		for (i = 0; i < TR_BUF_LIST_SIZE; i++) {
			...
			ilits->dbl[i].data =
				kzalloc(TR_BUF_SIZE * sizeof(unsigned char),
					GFP_KERNEL);
...
static int ilitek_debug_all_node_buff_control(bool open)
{
	...
	if (open) {
		...
		ilits->dbf_a = kzalloc(TR_BUF_LIST_SIZE * sizeof(*ilits->dbf_a),
				       GFP_KERNEL);
		...
		ilits->dbf_b = kzalloc(TR_BUF_LIST_SIZE * sizeof(*ilits->dbf_b),
				       GFP_KERNEL);
			       ...
			       u32 frame_count)
{
	...
	while (write_index < frame_count) {
		...
		if (!wait_event_interruptible_timeout(
			    ilits->inq, ilits->dbl[ilits->odi].mark,
					       ...
					       loff_t *pos)
{
	...
	len = snprintf(g_user_buf, PAGE_SIZE - len,
		       "======== Deltadata ========\n");
	ILI_INFO("======== Deltadata ========\n");
	...
	// print delta data
	for (y = 0; y < row; y++) {
		len += snprintf(g_user_buf + len, PAGE_SIZE - len, "[%2d] ",
				(y + 1));
		ILI_INFO("[%2d] ", (y + 1));
						...
						loff_t *pos)
{
	...
	rawdata =
		kcalloc(P5_X_DEBUG_MODE_PACKET_LENGTH, sizeof(s32), GFP_KERNEL);
...
int ili_hid_cascade_rw_tp_reg(u32 mcu, u32 type, u32 addr, u32 wdata, u32 wlen,
			      u32 *rdata)
{
	int ret = 0, len = 0;
	bool mcu_on = ON, read = 0;
	u32 read_data, backup_mspi;

	ili_hid_cascade_sync_ctrl(false);

	if (mcu == mcu_on)
		ret = ili_hid_ice_mode_ctrl_by_mode(ENABLE, ON, MASTER);
	else
		ret = ili_hid_ice_mode_ctrl_by_mode(ENABLE, OFF, MASTER);
	...
	if (ilits->client_wr_ctrl == CLIENT) {
		/* Backup mspi and set MSPI 0 */
		ili_hid_ice_mode_read_by_mode(MSPI_REG, &backup_mspi, 1,
					      MASTER);
		ILI_INFO("Backup Mspi = 0x%x\n", backup_mspi);
		ili_hid_ice_mode_write_by_mode(MSPI_REG, 0x00, 1, MASTER);

		/* set s to q = 1 */
		ili_hid_ice_mode_write_by_mode(SINGLE_TO_QUAL_REG, 0x02, 1,
					       MASTER);

		atomic_set(&ilits->ice_stat, DISABLE);

		if (mcu == mcu_on)
			ret = ili_hid_ice_mode_ctrl_by_mode(ENABLE, ON, CLIENT);
		else
			ret = ili_hid_ice_mode_ctrl_by_mode(ENABLE, OFF, CLIENT);
	}

	if (type == read) {
		if (ilits->client_wr_ctrl == CLIENT) {
			ili_hid_mspi_read_client_register(addr, &read_data,
							 sizeof(u32));
		} else {
			if (ili_hid_ice_mode_read_by_mode(addr, &read_data,
							  sizeof(u32),
							  MASTER) < 0) {
				len += snprintf(g_user_buf + len,
						USER_STR_BUFF - len, "%s\n",
						"Read data error");
			}
		}
		...
		*rdata = read_data;
		...
		if (ilits->client_wr_ctrl == CLIENT) {
			ili_hid_mspi_write_client_register(addr, wdata, wlen);
		} else {
			if (ili_hid_ice_mode_write_by_mode(addr, wdata, wlen,
							   MASTER) < 0) {
				len += snprintf(g_user_buf + len,
						USER_STR_BUFF - len, "%s\n",
						"Write data error");
		...
		ILI_INFO(
			...
			addr, wdata, wlen);
		len += snprintf(
			g_user_buf + len, USER_STR_BUFF - len,
			"WRITE:addr = 0x%06x, write = 0x%08x, len =%d byte\n",
			addr, wdata, wlen);
	}

	if (ilits->client_wr_ctrl == CLIENT) {
		/* set client exit ice mode */
		if (ili_hid_mspi_write_client_register(
			    CONTROL_CLIENT_EXIT_ICE_ADDR, 0, 0) < 0)
			ILI_ERR("Failed to disable Client ICE mode\n");
		else
			ILI_INFO("Disable Client ICE mode\n");

		/* Recovery mspi */
		ili_hid_ice_mode_write_by_mode(MSPI_REG, backup_mspi, 1, MASTER);
	}

	if (mcu == mcu_on)
		ret = ili_hid_ice_mode_ctrl_by_mode(DISABLE, ON, MASTER);
	else
		ret = ili_hid_ice_mode_ctrl_by_mode(DISABLE, OFF, MASTER);
					  ...
					  size_t size, loff_t *pos)
{
	...
	if (ilits->cascade_info_block.nNum != 0) {
#if (TDDI_INTERFACE == BUS_SPI)
		len = ili_hid_cascade_rw_tp_reg(stop_mcu, type, addr,
		...
		if (type == read) {
			if (ili_hid_ice_mode_read_by_mode(
				    addr, &read_data, sizeof(u32),
			...
			if (ili_hid_ice_mode_write_by_mode(
		...
		if (stop_mcu == mcu_on)
			ret = ili_hid_ice_mode_ctrl_by_mode(
				DISABLE, ON, ilits->client_wr_ctrl);
		else
			ret = ili_hid_ice_mode_ctrl_by_mode(
				DISABLE, OFF, ilits->client_wr_ctrl);
		...
		if (type == read) {
			if (ili_hid_ice_mode_read(addr, &read_data,
						  sizeof(u32)) < 0) {
			...
			if (ili_hid_ice_mode_write(addr, write_data,
						   write_len) < 0) {
		...
		if (stop_mcu == mcu_on)
			ret = ili_hid_ice_mode_ctrl(DISABLE, ON);
		else
			ret = ili_hid_ice_mode_ctrl(DISABLE, OFF);
...
static ssize_t ilitek_proc_fw_cmd_read(struct file *pFile, char __user *buf,
				       size_t size, loff_t *pos)
{
	int ret = 0, len = 0, i = 0;
	u8 *wrap_rbuf = NULL;
	...
	if (atomic_read(&ilits->ice_stat)) {
		ilits->wrapper(fw_cmd_buff + 4, wrap_wlen, wrap_rbuf, wrap_rlen,
			       OFF, OFF);
	} else {
		if (ilits->actual_tp_mode == P5_X_FW_TEST_MODE) {
			ilits->wrapper(fw_cmd_buff + 4, wrap_wlen, wrap_rbuf,
				       wrap_rlen, ON, ON);
		} else {
			ilits->wrapper(fw_cmd_buff + 4, wrap_wlen, wrap_rbuf,
				       wrap_rlen, ON, OFF);
	...
	ili_hid_dump_data(fw_cmd_buff + 4, 8, wrap_wlen, 16, "write fw data:");

	if (wrap_rlen > 0) {
		ili_hid_dump_data(wrap_rbuf, 8, wrap_rlen, 16, "read fw data:");
...
static ssize_t ilitek_proc_fw_cmd_write(struct file *filp, const char *buff,
					size_t size, loff_t *pos)
{
	char *token = NULL, *cur = NULL;
	char cmd[256] = { 0 };
...
static ssize_t tp_pen_serial_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	pen_disconnect_diff = ktime_to_ms(pen_touch_disconnect) -
			ktime_to_ms(ilits->pen_touch_time);
	...
	if (len < 0) {
		ILI_ERR("snprintf copy string failed. (%d)\n", len);
		return -EINVAL;
	}
...
static ssize_t ilitek_proc_debug_all_switch_read(struct file *pFile,
						 char __user *buff, size_t size,
						 loff_t *pos)
{
	bool open;
...
static int ilitek_proc_debug_all_message_show(struct seq_file *m, void *v)
{
	...
	do {
		if (ilits->dbf_out[count].mark) {
			if (ilits->dbf_out[count].data[0] ==
			    P5_X_DEMO_PACKET_ID) {
				need_read_data_len = P5_X_DEMO_MODE_PACKET_LEN;
			} else if (ilits->dbf_out[count].data[0] ==
				   P5_X_I2CUART_PACKET_ID) {
				type = ilits->dbf_out[count].data[3] & 0x0F;

				data_count = ilits->dbf_out[count].data[1] *
					     ilits->dbf_out[count].data[2];
				...
				need_read_data_len =
					data_count * one_data_bytes + 1 + 5;
					   ...
					   P5_X_DEBUG_PACKET_ID //A7
				   ||
				   ilits->dbf_out[count].data[0] ==
					   P5_X_DEBUG_HIGH_RESOLUTION_PACKET_ID //A8
				   ||
				   ilits->dbf_out[count].data[0] ==
					   P5_X_DEMO_HIGH_RESOLUTION_PACKET_ID //5B
				   || ilits->dbf_out[count].data[0] ==
					      P5_X_DEBUG_LITE_PACKET_ID) { //9A
				need_read_data_len =
					(int)((ilits->dbf_out[count].data[1]
					       << 8) +
					      ilits->dbf_out[count].data[2]) &
					0xFFFF;
			}
			if (ilits->pen_info.pen_data_mode ==
				    PEN_ONLY_SIGNAL_MODE ||
			    ilits->pen_info.pen_data_mode ==
				    PEN_ONLY_RAW_DATA_MODE) {
				seq_printf(m, ":0x80,");
			} else if (ilits->pen_info.pen_data_mode ==
...
static int ilitek_proc_debug_message_show(struct seq_file *m, void *v)
{
	...
	ILI_DBG("dbl mark = %d, data[0] = 0x%X, data[1] = 0x%X, data[2] = 0x%X \n",
		ilits->dbl[ilits->odi].mark, ilits->dbl[ilits->odi].data[0],
		ilits->dbl[ilits->odi].data[1], ilits->dbl[ilits->odi].data[2]);

	if (ilits->dbl[ilits->odi].mark) {
		if (ilits->dbl[ilits->odi].data[0] == P5_X_DEMO_PACKET_ID) {
			need_read_data_len = P5_X_DEMO_MODE_PACKET_LEN;
		} else if (ilits->dbl[ilits->odi].data[0] ==
			   P5_X_I2CUART_PACKET_ID) {
			type = ilits->dbl[ilits->odi].data[3] & 0x0F;

			data_count = ilits->dbl[ilits->odi].data[1] *
				     ilits->dbl[ilits->odi].data[2];
			...
			need_read_data_len =
			   ...
			   || ilits->dbl[ilits->odi].data[0] ==
				      P5_X_DEBUG_LITE_PACKET_ID) { //9A
			need_read_data_len =
				(int)((ilits->dbl[ilits->odi].data[1] << 8) +
				      ilits->dbl[ilits->odi].data[2]) &
				0xFFFF;
		}
		...
		for (i = 0; i < need_read_data_len; i++) {
			seq_printf(m, "%02X", ilits->dbl[ilits->odi].data[i]);
		}
		seq_printf(m, "\n\n");
		ilits->all_frame_full = false;
		ilits->dbl[ilits->odi].mark = false;
					      ...
					      loff_t *pos)
{
	...
	if (ERR_ALLOC_MEM(tmpbuf)) {
		...
		send_data_len +=
			snprintf(tmpbufback + send_data_len, sizeof(tmpbufback),
				 "buffer vmalloc error\n");
		ret = copy_to_user(buff, tmpbufback,
				   send_data_len); /*ilits->dbl[0] */
		goto out;
	}
	...
	if (ilits->dbl[ilits->odi].mark) {
		if (ilits->dbl[ilits->odi].data[0] == P5_X_DEMO_PACKET_ID) {
			need_read_data_len = 43;
			   ...
			   P5_X_DEMO_HIGH_RESOLUTION_PACKET_ID) {
			need_read_data_len =
				P5_X_DEMO_MODE_PACKET_LEN_HIGH_RESOLUTION;
			if (ilits->rib.nCustomerType !=
			...
			need_read_data_len =
				data_count * one_data_bytes + 1 + 5;
				   ...
				   P5_X_DEBUG_PACKET_ID ||
			   ilits->dbl[ilits->odi].data[0] ==
				   P5_X_DEBUG_LITE_PACKET_ID) {
			send_data_len = 0; /* ilits->dbl[0][1] - 2; */
			need_read_data_len = TR_BUF_SIZE - 8;
		} else if (ilits->dbl[ilits->odi].data[0] ==
			   P5_X_I2CUART_PACKET_ID) {
			need_read_data_len = P5_X_DEMO_MODE_PACKET_LEN +
					     P5_X_DEMO_MODE_AXIS_LEN +
					     P5_X_DEMO_MODE_STATE_INFO;
		} else if (ilits->dbl[ilits->odi].data[0] ==
			   P5_X_DEBUG_HIGH_RESOLUTION_PACKET_ID) {
			send_data_len = 0; /* ilits->dbl[0][1] - 2; */
			need_read_data_len = TR_BUF_SIZE - 8;
		}
						    ...
						    size_t size, loff_t *pos)
{
	...
	csv.wlen += snprintf(csv.ptr + csv.wlen, (csv.max_size - csv.wlen),
			     "\n\n=======Raw data=======");
	file_hid_write(&csv, false);

	ret = debug_mode_get_data(&csv, P5_X_FW_RAW_DATA_MODE,
				  ilits->raw_count);
	if (ret < 0)
		goto out;
	...
	ret = debug_mode_get_data(&csv, P5_X_FW_SIGNAL_DATA_MODE,
				  ilits->delta_count);
	if (ret < 0)
		goto out;
					       ...
					       loff_t *pos)
{
	...
	ret = ili_hid_mp_test_handler(g_user_buf, ON);
						...
						loff_t *pos)
{
	...
	ret = ili_hid_mp_test_handler(g_user_buf, OFF);
	ILI_INFO("MP TEST %s, Error code = %d\n", (ret < 0) ? "FAIL" : "PASS",
		 ret);
					 ...
					 size_t size, loff_t *pos)
{
	...
	len += snprintf(g_user_buf + len, USER_STR_BUFF - len,
			"FW version = %d.%d.%d.%d\n", ilits->chip->fw_ver >> 24,
			(ilits->chip->fw_ver >> 16) & 0xFF,
			(ilits->chip->fw_ver >> 8) & 0xFF,
			ilits->chip->fw_ver & 0xFF);
	len += snprintf(g_user_buf + len, USER_STR_BUFF - len,
			"FW MP version = %d.%d.%d.%d\n",
			ilits->chip->fw_mp_ver >> 24,
			(ilits->chip->fw_mp_ver >> 16) & 0xFF,
			(ilits->chip->fw_mp_ver >> 8) & 0xFF,
			ilits->chip->fw_mp_ver & 0xFF);

	if (ilits->protocol->core_ver_len == P5_X_CORE_VER_THREE_LENGTH)
		len += snprintf(g_user_buf + len, USER_STR_BUFF - len,
				"Core version = %d.%d.%d\n",
				(ilits->chip->core_ver >> 24) & 0xFF,
				(ilits->chip->core_ver >> 16) & 0xFF,
					   ...
					   size_t size, loff_t *pos)
{
	...
	len = snprintf(g_user_buf, USER_STR_BUFF * sizeof(unsigned char),
					   ...
					   size_t size, loff_t *pos)
{
	...
	ret = ili_hid_fw_upgrade_handler(NULL);
	...
	len += snprintf(g_user_buf + len, USER_STR_BUFF - len, "%3d ",
			(ret == 0) ? 1 : ret);
	...
	}  else if (ret == EFW_HEXSIGH) {
		len += snprintf(g_user_buf + len, USER_STR_BUFF - len, "%s\n",
				"Failed to hex file sign error, abort!");
	}
...
static ssize_t ilitek_proc_sram_test_info(struct file *filp, char __user *buff,
					  size_t size, loff_t *pos)
{
	int len = 0, ret = 0;
	...
	if (ilits->cascade_info_block.nNum != 0) {
		ret = ili_hid_cascade_reset_ctrl(TP_IC_WHOLE_RST_WITH_FLASH,
						 true);
	} else {
		ret = ili_hid_reset_ctrl(TP_IC_WHOLE_RST_WITH_FLASH);
	}
	...
	if (((ilits->chip->pid & 0xFFFFFF00) == ILI9881N_AA) ||
		...
		ili_hid_ice_mode_write_by_mode(0x8003F, 0x8A, 1, BOTH);
		ili_hid_ice_mode_write_by_mode(0x8003C, 0x00, 1, BOTH);
	}

	ret = ili_hid_tddi_ic_sram_test();
	if (ret < 0) {
		len += snprintf(g_user_buf + len, USER_STR_BUFF - len, "%s\n",
				"SRAM TEST Failed");
	} else {
...
int ili_hid_get_tp_recore_ctrl(int data)
{
	int ret = 0;
	...
	case ENABLE_RECORD:
		...
		ret = ili_hid_ic_func_ctrl("tp_recore", 1);
		mdelay(200);
		break;
	case DATA_RECORD:
		mdelay(50);
		ILI_INFO("Get data");
		ret = ili_hid_ic_func_ctrl("tp_recore", 2);
		if (ret < 0) {
			ILI_ERR("cmd fail\n");
			goto out;
		}

		ret = ili_hid_get_tp_recore_data(ON);
		if (ret < 0)
			ILI_ERR("get data fail\n");

		ILI_INFO("recore reset");
		ret = ili_hid_ic_func_ctrl("tp_recore", 3);
		if (ret < 0) {
			ILI_ERR("cmd fail\n");
			goto out;
		}
	...
	case DISABLE_RECORD:
		...
		ret = ili_hid_ic_func_ctrl("tp_recore", 0);
		break;
	}
out:
	return ret;
...
int ili_hid_get_tp_recore_data(bool mcu)
{
	...
	ili_hid_dump_data(buf, 8, sizeof(buf), 0, "all record bytes");
	...
	for (i = 0; i < fcnt; i++) {
		...
		ili_hid_dump_data(raw_ptr, 16, frame_len, ilits->xch_num,
				  "recore_data");
		index--;
		if (index < 0)
			index = fcnt - 1;
...
void ili_hid_gesture_fail_reason(bool enable)
{
	u8 cmd[24] = { 0 };

	/* set symbol */
	if (ili_hid_ic_func_ctrl("knock_en", 0x8) < 0)
...
int ili_tp_data_mode_ctrl(u8 *cmd)
{
	...
	case AP_MODE:
		if (ilits->tp_suspend) {
			if (ili_hid_set_tp_data_len(DATA_FORMAT_GESTURE_DEMO,
						    false, NULL) < 0) {
			...
			if (ilits->actual_tp_mode == P5_X_FW_TEST_MODE) {
				if (ili_hid_switch_tp_mode(P5_X_FW_AP_MODE) < 0) {
					ILI_ERR("Failed to switch demo mode\n");
					ret = -ENOTTY;
				}
			} else {
				if (ili_hid_set_tp_data_len(DATA_FORMAT_DEMO,
							    false, NULL) < 0) {
					ILI_ERR("Failed to switch demo mode\n");
					ret = -ENOTTY;
				}
		...
		break;
	case TEST_MODE:
		if (ili_hid_switch_tp_mode(P5_X_FW_TEST_MODE) < 0) {
	...
	case DEBUG_MODE:
		...
		if (ilits->tp_suspend) {
			if (ili_hid_set_tp_data_len(DATA_FORMAT_GESTURE_DEBUG,
						    false, &cmd[1]) < 0) {
				ILI_ERR("Failed to set debug len from gesture mode\n");
				ret = -ENOTTY;
			}
		} else {
			if (ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG, false,
						    &cmd[1]) < 0) {
		...
		break;
	case DEBUG_LITE_ROI:
		if (ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG_LITE_ROI, false,
					    &cmd[1]) < 0) {
	...
	case DEBUG_LITE_WINDOW:
		if (ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG_LITE_WINDOW,
					    false, &cmd[1]) < 0) {
	...
	case DEBUG_LITE_AREA:
		if (ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG_LITE_AREA, false,
					    &cmd[1]) < 0) {
	...
	case DEBUG_PEN_ONLY_MODE:
		if (ilits->PenType == POSITION_PEN_TYPE_ON) {
			...
			if (ili_hid_set_pen_data_len(P5_X_NEW_CONTROL_FORMAT,
						     DATA_FORMAT_DEBUG_PEN_CMD,
						     cmd[1]) < 0) {
...
int ili_mp_lcm_off_env_ctrl(u8 lcm_on)
{
	...
	if (lcm_on == ENABLE) {
		...
		/* enable gesture */
		atomic_set(&ilits->gesture, ENABLE);
		panel_gesture_mode_set_by_ili9882t(true);
	}
	return ret;
}
				       ...
				       size_t size, loff_t *pos)
{
	...
	if (strncmp(cmd, "hwreset", strlen(cmd)) == 0) {
		...
		ili_hid_reset_ctrl(TP_HW_RST_ONLY);
	} else if (strcmp(cmd, "rawdatarecore") == 0) {
		if (data[1] == ENABLE_RECORD)
			ili_hid_get_tp_recore_ctrl(ENABLE_RECORD);
		else if (data[1] == DATA_RECORD)
			ili_hid_get_tp_recore_ctrl(DATA_RECORD);
		else if (data[1] == DISABLE_RECORD)
			ili_hid_get_tp_recore_ctrl(DISABLE_RECORD);
	} else if (strcmp(cmd, "switchdemodebuginfomode") == 0) {
		ili_hid_set_tp_data_len(DATA_FORMAT_DEMO_DEBUG_INFO, false,
					NULL);
		...
		ili_hid_set_tp_data_len(DATA_FORMAT_GESTURE_DEMO, false, NULL);
	} else if (strcmp(cmd, "gesturefailrsn") == 0) {
		if (data[1] == DISABLE)
			ili_hid_gesture_fail_reason(DISABLE);
		else
			ili_hid_gesture_fail_reason(ENABLE);
		ILI_INFO("%s gesture fail reason\n",
			 data[1] ? "ENABLE" : "DISABLE");
	} else if (strncmp(cmd, "icwholereset", strlen(cmd)) == 0) {
		if (ilits->cascade_info_block.nNum != 0) {
			ili_hid_cascade_reset_ctrl(TP_IC_WHOLE_RST_WITH_FLASH,
						   true);
		} else {
			ili_hid_ice_mode_ctrl(ENABLE, OFF);
			ili_hid_reset_ctrl(TP_IC_WHOLE_RST_WITH_FLASH);
		}
	} else if (strncmp(cmd, "icwholeresetwithoutflash", strlen(cmd)) == 0) {
		if (ilits->cascade_info_block.nNum != 0) {
			ili_hid_cascade_reset_ctrl(
				TP_IC_WHOLE_RST_WITHOUT_FLASH, true);
		} else {
			ili_hid_ice_mode_ctrl(ENABLE, OFF);
			ili_hid_reset_ctrl(TP_IC_WHOLE_RST_WITHOUT_FLASH);
		}
	} else if (strncmp(cmd, "iccodereset", strlen(cmd)) == 0) {
		if (ilits->cascade_info_block.nNum != 0) {
			ili_hid_cascade_reset_ctrl(TP_IC_CODE_RST, true);
		} else {
			ili_hid_ice_mode_ctrl(ENABLE, OFF);
			ili_hid_reset_ctrl(TP_IC_CODE_RST);
			ili_hid_ice_mode_ctrl(DISABLE, OFF);
		}
		...
		if (ilits->cascade_info_block.nNum != 0) {
			if (ili_hid_cascade_ic_get_info(true, true) < 0)
		...
		ili_hid_ic_get_protocl_ver();
		ili_hid_ic_get_fw_ver();
		ili_hid_ic_get_core_ver();
		ili_hid_ic_get_tp_info();
		ili_hid_ic_get_panel_info();
	...
	} else if (strcmp(cmd, "spiwrclientreg") == 0) {
		ilits->client_wr_ctrl = (data[1] == ENABLE) ? CLIENT : MASTER;
		ILI_INFO(" %s client write read ctrl = %x\n",
			 ilits->client_wr_ctrl ? "Enable" : "Disable",
			 ilits->client_wr_ctrl);
	} else if (strncmp(cmd, "file_hid_write", strlen(cmd)) == 0) {
		/*For Wacom Test Pen ID*/
		struct file_buffer csv;

		memset(csv.fname, 0, sizeof(csv.fname));
		snprintf(csv.fname, sizeof(csv.fname), "%s",
			 PEN_ID_NODE_TEST_PATH);
		csv.wlen = 0;
		...
		memset(csv.ptr, 0, csv.max_size);
		csv.wlen += snprintf(csv.ptr + csv.wlen,
				     (csv.max_size - csv.wlen), "PEN_ID = 0x");
		for (i = 0; i < P5_X_PEN_ID_LEN; i++) {
			ILI_INFO(
				"Pen ID[%d] = 0x%02X", i,
				ilits->pen_info.pen_id[P5_X_PEN_ID_LEN - 1 - i]);
			csv.wlen += snprintf(
				csv.ptr + csv.wlen, (csv.max_size - csv.wlen),
				"%02X",
				ilits->pen_info.pen_id[P5_X_PEN_ID_LEN - 1 - i]);
		}
		ILI_INFO("\n");
		csv.wlen += snprintf(csv.ptr + csv.wlen,
				     (csv.max_size - csv.wlen), "\n");
		file_hid_write(&csv, true);
		...
		atomic_set(&ilits->gesture, !(atomic_read(&ilits->gesture)));
		panel_gesture_mode_set_by_ili9882t(
			atomic_read(&ilits->gesture));
		ILI_INFO("gesture = %d\n", atomic_read(&ilits->gesture));
		...
		atomic_set(&ilits->gesture, DISABLE);
		panel_gesture_mode_set_by_ili9882t(
			atomic_read(&ilits->gesture));
		ILI_INFO("gesture = %d\n", atomic_read(&ilits->gesture));
	} else if (strncmp(cmd, "esdgesture", strlen(cmd)) == 0) {
		if (ili_hid_gesture_recovery() < 0) {
		...
		ili_hid_ic_func_ctrl("sleep", SLEEP_IN);
	} else if (strncmp(cmd, "deepsleepin", strlen(cmd)) == 0) {
		ili_hid_ic_func_ctrl("sleep", DEEP_SLEEP_IN);
		...
		if (ilits->chip->core_ver >= CORE_VER_1700) {
			...
			ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG, false,
						&data_type);
		} else {
			ili_hid_set_tp_data_len(DATA_FORMAT_DEBUG, false, NULL);
		}
	} else if (strncmp(cmd, "switchdemomode", strlen(cmd)) == 0) {
		ili_hid_set_tp_data_len(DATA_FORMAT_DEMO, false, NULL);
	} else if (strncmp(cmd, "switchgesturedebugmode", strlen(cmd)) == 0) {
		ili_hid_set_tp_data_len(DATA_FORMAT_GESTURE_DEBUG, false, NULL);
		...
		ILI_INFO("Get ddi reg one page: page = %x, reg = %x\n", data[1],
			 data[2]);
		ili_hid_ic_get_ddi_reg_onepage(data[1], data[2], &ddi_data,
					       OFF);
		ILI_INFO("ddi_data = %x\n", ddi_data);
		...
		ili_hid_ic_set_ddi_reg_onepage(data[1], data[2], data[3], OFF);
		...
		ret = ili_hid_fw_dump_flash_data(data[1], data[2], false, OFF);
		ilits->fw_update_stat =
			(ret < 0) ? FW_UPDATE_FAIL : FW_UPDATE_PASS;
		...
		ptr[1] = data[2];
		ptr[2] = data[3];
		ili_hid_dump_data(ptr, 8, 3, 0, "Gesture symbol");
		...
		if (ilits->knuckle == true) {
			ili_hid_config_knuckle_roi_ctrl(CMD_ENABLE);
		} else {
			ili_hid_config_knuckle_roi_ctrl(CMD_DISABLE);
		}
		ILI_INFO("knuckle = %s\n",
		...
		if (data[1] != 0x00) {
			...
			if (ili_hid_ic_func_ctrl("proximity", data[1]) < 0) {
				ILI_ERR("Write proximity cmd failed\n");
			}
		} else {
			ilits->prox_face_mode = false;
			if (ili_hid_ic_func_ctrl("proximity", 0x00) < 0) {
				ILI_ERR("Write proximity cmd failed\n");
			}
		}
			      ...
			      unsigned long arg)
{
	...
	case ILITEK_IOCTL_TP_HW_RESET:
		...
		ili_hid_reset_ctrl(ilits->reset);
		break;
	...
	case ILITEK_IOCTL_TP_DRV_VER:
		...
		length = snprintf(szBuf, USER_STR_BUFF * sizeof(unsigned char),
				  "%s", DRIVER_VERSION);
	...
	case ILITEK_IOCTL_TP_CHIP_ID:
		...
		id_to_user[0] = (ilits->chip->product_id << 16) |
				(ilits->chip->pid & 0x0000FFFF);
	...
	case ILITEK_IOCTL_TP_MODE_STATUS:
		ILI_DBG("ioctl: current firmware mode = %d",
			ilits->tp_data_mode);
		if (copy_to_user((int *)arg, &ilits->tp_data_mode,
				 sizeof(int))) {
			ILI_ERR("Failed to copy driver ver to user space\n");
			ret = -ENOTTY;
		}
...
#if (TDDI_INTERFACE == BUS_I2C)
			ili_hid_ice_mode_ctrl_by_mode(
				szBuf[0] ? ENABLE : DISABLE,
				szBuf[1] ? ENABLE : DISABLE,
				ilits->client_wr_ctrl);

#elif (TDDI_INTERFACE == BUS_SPI)
			if (ilits->client_wr_ctrl == ENABLE &&
			    szBuf[0] == ENABLE) {
				ili_hid_set_bypass_mode();
			}

			if (ili_hid_ice_mode_ctrl(szBuf[0] ? ENABLE : DISABLE,
	...
	case ILITEK_IOCTL_TP_DUMP_FLASH:
		...
		ret = ili_hid_fw_dump_flash_data(0, 0, true, OFF);
		if (ret < 0) {
	...
	case ILITEK_IOCTL_WRAPPER_RW:
		...
		ili_hid_dump_data(szBuf + 5, 8, wrap_wlen, 16, "wrap_wbuf:");
		ili_hid_dump_data(wrap_rbuf, 8, wrap_rlen, 16, "wrap_rbuf:");
	...
	case ILITEK_IOCTL_DDI_WRITE:
		...
		ILI_DBG("ioctl: page = %x, reg = %x, data = %x\n", szBuf[0],
			szBuf[1], szBuf[2]);
		ili_hid_ic_set_ddi_reg_onepage(szBuf[0], szBuf[1], szBuf[2],
					       OFF);
		break;
	case ILITEK_IOCTL_DDI_READ:
		...
		ili_hid_ic_get_ddi_reg_onepage(szBuf[0], szBuf[1], &szBuf[2],
					       OFF);
	...
	case ILITEK_IOCTL_REPORT_RATE_SET:
		...
		if (ili_hid_ic_report_rate_set(szBuf[0]) < 0) {
	...
	case ILITEK_IOCTL_REPORT_RATE_GET:
		...
		szBuf[0] = ili_hid_ic_report_rate_get();
	...
	case ILITEK_IOCTL_CLIENT_CTRL:
		...
		ilits->client_wr_ctrl = (szBuf[0] == ENABLE) ? ENABLE : DISABLE;
		ILI_DBG(" %s client write read ctrl = %x\n",
			ilits->client_wr_ctrl ? "Enable" : "Disable",
			ilits->client_wr_ctrl);
		break;
	case ILITEK_IOCTL_CASCADE_REG_RW:
		...
		type = szBuf[0];
		addr = (szBuf[1] << 24) + (szBuf[2] << 16) + (szBuf[3] << 8) +
		       (szBuf[4]);
		write_data = (szBuf[5] << 24) + (szBuf[6] << 16) +
			     (szBuf[7] << 8) + (szBuf[8]);
		write_len = szBuf[9];
...
#if (TDDI_INTERFACE == BUS_I2C)
		if (type == read) {
			ili_hid_ice_mode_read_by_mode(addr, &read_data,
						      sizeof(u32),
						      ilits->client_wr_ctrl);
			...
			ili_hid_ice_mode_write_by_mode(addr, write_data,
						       write_len,
						       ilits->client_wr_ctrl);
		}
#else
		if (type == read) {
			if (ilits->client_wr_ctrl == CLIENT) {
				ili_hid_mspi_read_client_register(
					addr, &read_data, sizeof(u32));
				ili_hid_ice_mode_write_by_mode(MSPI_REG, 0x00,
							       1, BOTH);
			} else {
				if (ili_hid_ice_mode_read_by_mode(
					    addr, &read_data, sizeof(u32),
			...
			if (ilits->client_wr_ctrl == CLIENT) {
				ili_hid_mspi_write_client_register(
					addr, write_data, write_len);
				ili_hid_ice_mode_write_by_mode(MSPI_REG, 0x00,
							       1, BOTH);
			} else {
...
#if DMESG_SEQ_FILE
static int ilitek_proc_seq_debug_message_read(struct inode *inode,
					      struct file *file)
{
	if (atomic_read(&ilits->tp_reset) == START) {
		ILI_ERR("ignore request! tp reset atomic is START.\n");
	...
	return single_open_size(file, ilitek_proc_debug_message_show, NULL,
				16 * K);
}
...
static int ilitek_proc_seq_debug_all_message_read(struct inode *inode,
						  struct file *file)
{
	if (atomic_read(&ilits->tp_reset) == START) {
		ILI_ERR("ignore request! tp reset atomic is START.\n");
	...
	return single_open_size(file, ilitek_proc_debug_all_message_show, NULL,
				500 * K);
}
...
proc_node iliproc[] = {
	...
	{ "debug_message_switch", NULL, &proc_debug_message_switch_fops,
	  false },
	{ "debug_all_message", NULL, &proc_debug_all_message_fops, false },
	{ "debug_all_message_switch", NULL, &proc_debug_all_message_switch_fops,
	  false },
	...
	{ "tp_fw_version", NULL, &proc_ver_info_fops, false },
				   ...
				   struct device_attribute *attr, char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "Gesture = %d\n",
		       atomic_read(&ilits->gesture));
	if (ret < 0)
		ILI_ERR("snprintf copy string failed %d", ret);
				    ...
				    const char *buf, size_t count)
{
	...
	case 0:
		...
		atomic_set(&ilits->gesture, DISABLE);
		panel_gesture_mode_set_by_ili9882t(false);
		break;
	case 1:
...
static struct attribute *ili_api_attrs[] = {
	&dev_attr_gesture_wakeup.attr,
	&dev_attr_tp_pen_serial.attr,
	NULL };

static const struct attribute_group ili_api_attribute_group = {
	.attrs = ili_api_attrs,
};
...
void ili_hid_netlink_reply_msg(void *raw, int size)
{
	int ret;
	int msg_size = size;
	u8 *data = (u8 *)raw;
	...
	if (ilits->netlink) {
		...
		netlink_head =
			nlmsg_put(skb_out, 0, 0, NLMSG_DONE, msg_size, 0);
...
static int netlink_init(void)
{
	...
	netlink_skb = netlink_kernel_create(
		&init_net, NETLINK_USER, netlink_recv_msg, NULL, THIS_MODULE);
#else
...
static int ilitek_stylus_report_uevent(struct device *dev,
				       struct kobj_uevent_env *env)
{
	int ret = 0;

	if (!ilits) {
		ILI_ERR("%s: ilits is NULL\n", __func__);
		return -EINVAL;
	}

	ret = add_uevent_var(env, "STYLUS_LEVEL=%s",
			     ilits->stylus_uevent.stylus_capacity);
	ret = add_uevent_var(env, "STYLUS_VENDOR=%s",
			     ilits->stylus_uevent.stylus_vendor);
	ret = add_uevent_var(env, "STYLUS_VENDOR_ID=%s",
			     ilits->stylus_uevent.stylus_vendor_id);
	ret = add_uevent_var(env, "STYLUS_STATUS=%s",
			     ilits->stylus_uevent.stylus_status);
	return ret;
}
...
int ilitek_stylus_uevent(const u8 *raw_data, bool new_pen)
{
	...
	if (!ilits || !ilits->stylus_dev || !raw_data) {
		ILI_ERR("%s: Ilitek device or stylus device or raw_data is NULL\n",
			__func__);
		return -EINVAL;
	}
	...
	stylus_oem_vendor_id =
		(raw_data[ILITEK_HID_PEN_VENDOR_USAGE_1_H] << 8) |
		raw_data[ILITEK_HID_PEN_VENDOR_USAGE_1_L];
	...
	snprintf(ilits->stylus_uevent.stylus_vendor, ENV_SIZE, "%s", "amzn");
...
int ili_stylus_uevent_init(void)
{
	int ret = 0;

	ret = alloc_chrdev_region(&ilits->stylus_dev_num, 0, 1,
				  "stylus_dev_num");
	if (ilits->stylus_dev_num < 0) {
		ILI_ERR("stylus dev num chrdev region error!\n");
		return -EINVAL;
	}

	ilits->stylus_class = class_create(THIS_MODULE, "stylus_uevent");
	if (IS_ERR(ilits->stylus_class)) {
		ILI_ERR("create demo class err!\n");
		ret = -EINVAL;
		goto class_creat_fail;
	}

	ilits->stylus_dev =
		device_create(ilits->stylus_class, NULL, ilits->stylus_dev_num,
			      NULL, "stylus_dev");
	if (ilits->stylus_dev == NULL) {
		ILI_ERR("device_create error\n");
		ret = -EINVAL;
		goto dev_creat_fail;
	}
	ilits->stylus_class->dev_uevent = ilitek_stylus_report_uevent;

	return 0;
dev_creat_fail:
	class_destroy(ilits->stylus_class);
	ilits->stylus_class = NULL;
class_creat_fail:
	unregister_chrdev_region(ilits->stylus_dev_num, 1);
	return ret;
}

void ili_stylus_uevent_remove(void)
{
	if (ilits->stylus_dev_num >= 0)
		unregister_chrdev_region(ilits->stylus_dev_num, 1);
	if (ilits->stylus_dev)
		device_destroy(ilits->stylus_class, ilits->stylus_dev_num);
	if (ilits->stylus_class)
		class_destroy(ilits->stylus_class);
}

void ili_hid_node_init(void)
{
	int i = 0, ret = 0;
	...
	for (; i < ARRAY_SIZE(iliproc); i++) {
		if (strncmp(iliproc[i].name, "tp_fw_version", strlen(iliproc[i].name)) == 0) {
			iliproc[i].node = proc_create(iliproc[i].name, 0444,
							NULL, iliproc[i].fops);
		} else {
			iliproc[i].node = proc_create(iliproc[i].name, 0644,
							proc_dir_ilitek, iliproc[i].fops);
		}
	...
	if (touchscreen_link != NULL) {
		ret = sysfs_create_link(touchscreen_link, &client->dev.kobj,
					"link_input_dev");
		if (ret < 0) {
			ILI_ERR("Failed to create sysfs link for input_dev %d\n",
				ret);
		} else {
			if (sysfs_create_group(&client->dev.kobj,
					       &ili_api_attribute_group))
				ILI_ERR("Failed to create gesture_wakeup gesture sysfs");
			else
				ILI_INFO("create gesture_wakeup Succeeded!\n");
		}
	}
	netlink_init();
}

void ili_sysfs_remove_group(struct ilitek_ts_hid_data *ts)
{
	sysfs_remove_group(&ts->i2c->dev.kobj, &ili_api_attribute_group);
}
