...
struct msdc_host {
	...
	struct pm_qos_request pm_qos_req; /* avoid CPU idle latency */
	struct regulator *vcore_reg;
	u32 vcore_max_volt;
	bool should_dump_register;
};
...
static const struct mtk_mmc_compatible mt8169_compat = {
	.clk_div_bits = 12,
	.hs400_tune = false,
	.pad_tune_reg = MSDC_PAD_TUNE0,
	.async_fifo = true,
...
static const struct mtk_mmc_compatible mt8188_compat = {
	.clk_div_bits = 12,
	.hs400_tune = false,
	.pad_tune_reg = MSDC_PAD_TUNE0,
	.async_fifo = true,
