...
#if  defined(CONFIG_GPU_MT8188) || defined(CONFIG_GPU_MT6853) || defined(CONFIG_GPU_MT8195)
/* GPU ID: 0x90930000 */
#define GPU_ID2_PRODUCT_TNAX              GPU_ID2_MODEL_MAKE(9, 3)
#define GPU_ID2_PRODUCT_TBEX              GPU_ID2_MODEL_MAKE(9, 4)
#define GPU_ID2_PRODUCT_LBEX              GPU_ID2_MODEL_MAKE(9, 5)
#else
