...
unsigned long mtk_devfreq_get_voltage(unsigned long target_freq)
{
...
void mtk_devfreq_set_cur_freq(unsigned long cur_freq)
{
	struct kbase_device *kbdev;
...
int kbase_devfreq_init(struct kbase_device *kbdev)
{
	...
	mtk_devfreq_get_voltage_fp = mtk_devfreq_get_voltage;
