...
#define RDMA_MATRIX_INT_MTX_SEL (0xf << 20)
...
static const struct mtk_disp_rdma_data mt8188_rdma_driver_data = {
	.fifo_size = SZ_1K * 3 + SZ_32K,
	.pre_ultra_low_us = 250,
	.pre_ultra_high_us = 260,
	.ultra_low_us = 230,
...
static const struct of_device_id mtk_disp_rdma_driver_dt_match[] = {
	...
	{.compatible = "mediatek,mt8188-disp-rdma",
	 .data = &mt8188_rdma_driver_data}, // same as 8195
	{},
};
