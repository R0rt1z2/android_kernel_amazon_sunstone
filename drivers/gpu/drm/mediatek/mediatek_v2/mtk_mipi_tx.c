...
static int mtk_mipi_tx_pll_prepare_mt6885(struct clk_hw *hw)
{
	...
	if (mipi_tx->lk_fastlogo) {
		DDPINFO("%s, mipi_tx already power on in lk\n", __func__);
		return 0;
	}
#endif
...
#ifdef CONFIG_DEM_EN
	/*DSI_DEM_EN*/
	mtk_mipi_tx_update_bits(mipi_tx, MIPITX_LANE_CON,
...
static const struct of_device_id mtk_mipi_tx_match[] = {
	...
	{.compatible = "mediatek,mt8195-mipi-tx", .data = &mt6885_mipitx_data},
	{.compatible = "mediatek,mt8195-mipi-tx-cphy",
		.data = &mt6885_mipitx_cphy_data},
	{},
};
