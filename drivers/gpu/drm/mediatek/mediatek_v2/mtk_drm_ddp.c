...
#define DISP_REG_MUTEX_MOD0(data, n) \
	(data->mutex_mod0_reg ? \
	 data->mutex_mod0_reg + 0x20 * (n) : 0)
#define DISP_REG_MUTEX_MOD1(data, n) \
	(data->mutex_mod1_reg ? \
	 data->mutex_mod1_reg + 0x20 * (n) : 0)

#define SOF_FLD_MUTEX0_SOF REG_FLD(3, 0)
#define SOF_FLD_MUTEX0_SOF_TIMING REG_FLD(2, 4)
#define MUTEX_SOF_TIMING_VSYNC_FAILING_EDGE 0
#define MUTEX_SOF_TIMING_VSYNC_RISING_EDGE 1
...
#define MT8195_GLOBAL0_CG_CON0 0x100
#define MT8195_GLOBAL0_CG_CON1 0x110

#define MT8195_VDO0_DL_RELAY0_CFG_WD 0x240
#define MT8195_VDO0_DL_RELAY1_CFG_WD 0x244
#define MT8195_VDO0_DL_RELAY2_CFG_WD 0x248
#define MT8195_VDO0_DL_RELAY3_CFG_WD 0x24C
#define MT8195_VDO0_DL_RELAY4_CFG_WD 0x250
#define MT8195_VDO0_DL_RELAY5_CFG_WD 0x254

#define MT8195_VDO0_SMI_LARB0_GREQ 0x8DC
#define MT8195_VDO0_SMI_LARB1_GREQ 0x8E0

#define MT8195_VDO0_DL_VALID0 0xE30
#define MT8195_VDO0_DL_VALID1 0xE34
#define MT8195_VDO0_DL_VALID2 0xE38
#define MT8195_VDO0_DL_VALID3 0xE3C
#define MT8195_VDO0_DL_VALID4 0xE40
#define MT8195_VDO0_DL_VALID5 0xE44
#define MT8195_VDO0_DL_READY0 0xE50
#define MT8195_VDO0_DL_READY1 0xE54
#define MT8195_VDO0_DL_READY2 0xE58
#define MT8195_VDO0_DL_READY3 0xE5C
#define MT8195_VDO0_DL_READY4 0xE60
#define MT8195_VDO0_DL_READY5 0xE64
...
#define MT8195_MUTEX_SOF_SINGLE_MODE 0
...
/*For MT8188*/
#define MT8188_GLOBAL0_CG_CON0 0x100
#define MT8188_GLOBAL0_CG_CON1 0x110

#define MT8188_VDO0_SMI_LARB0_GREQ 0x8DC
#define MT8188_VDO0_SMI_LARB1_GREQ 0x8E0

#define MT8188_VDO0_DL_VALID0 0xE30
#define MT8188_VDO0_DL_VALID1 0xE34
#define MT8188_VDO0_DL_VALID2 0xE38
#define MT8188_VDO0_DL_VALID3 0xE3C
#define MT8188_VDO0_DL_VALID4 0xE40
#define MT8188_VDO0_DL_VALID5 0xE44
#define MT8188_VDO0_DL_READY0 0xE50
#define MT8188_VDO0_DL_READY1 0xE54
#define MT8188_VDO0_DL_READY2 0xE58
#define MT8188_VDO0_DL_READY3 0xE5C
#define MT8188_VDO0_DL_READY4 0xE60
#define MT8188_VDO0_DL_READY5 0xE64
...
#define MT8188_VDO0_OVL_MOUT_EN 0xf14
	...
	#define MT8188_MOUT_DISP_OVL0_TO_DISP_RSZ0 BIT(3)
	#define MT8188_MOUT_DISP_OVL1_TO_DISP_WROT0 BIT(4)

#define MT8188_VDO0_SEL_IN 0xf34
	#define MT8188_SEL_IN_VDO0AVDO1_FROM_VPP_MERGE0  0
	#define MT8188_SEL_IN_VDO0AVDO1_FROM_DSC_WRAP0C1  1
	#define MT8188_SEL_IN_VDO0AVDO1_FROM_DITHER0	 2

	#define MT8188_SEL_IN_VDO0BVDO1_FROM_MOUT_DSC_WRAP0C0 (0 << 4)

#define MT8188_VDO0_SEL_OUT 0xf38
	#define MT8188_SOUT_VDO1_VDO0_TO_MERGE0 0
	#define MT8188_SOUT_VDO1_VDO0_TO_DP_INTFO 1

#define MT8188_VDO0_DISP_RDMA_SEL 0xf40
	#define MT8188_SOUT_DISP_RDMA_TO_DISP_COLOR0 0
	#define MT8188_SOUT_DISP_RDMA_TO_DSI0 1
	#define MT8188_SOUT_DISP_RDMA_TO_DSI1 4
	#define MT8188_SOUT_DISP_RDMA_TO_DP_INTF0 5

	#define MT8188_SEL_IN_DISP_RDMA0_FROM_OVL0 (0 << 8)
	#define MT8188_SEL_IN_DISP_RDMA0_FROM_RSZ0 (1 << 8)

#define MT8188_VDO0_DSI0_SEL 0xf44
	#define MT8188_SEL_IN_DISP_DSI0_FROM_DSC_MOUT 0
	#define MT8188_SEL_IN_DISP_DSI0_FROM_DITHER0 1
	#define MT8188_SEL_IN_DISP_DSI0_FROM_RDMA0 2

#define MT8188_VDO0_DSI1_SEL 0xf48
	#define MT8188_SEL_IN_DISP_DSI1_FROM_DSC_WRAP0 0
	#define MT8188_SEL_IN_DISP_DSI1_FROM_MERGE0 1
	#define MT8188_SEL_IN_DISP_DSI1_FROM_DISP_RDMA0 2

#define MT8188_VDO0_DP_INTF0_SEL 0xf4C
	#define MT8188_SEL_IN_DP_INTF0_FROM_DSC_WAPR0 0
	#define MT8188_SEL_IN_DP_INTF0_FROM_VPP_MERGE0 1
	#define MT8188_SEL_IN_DP_INTF0_FROM_VDOSYS1_SOUT 2
	#define MT8188_SEL_IN_DP_INTF0_FROM_DITHER0 3
	#define MT8188_SEL_IN_DP_INTF0_FROM_DISP_RDMA0 4

#define MT8188_VDO0_DISP_DITHER0_SEL 0xf58
	#define MT8188_SOUT_DITHER0_TO_DSC_WRAP0 0
	#define MT8188_SOUT_DITHER0_TO_DSI0 1
	#define MT8188_SOUT_DITHER0_TO_SINA_VDO0_VDO1 4
	#define MT8188_SOUT_DITHER0_TO_DSC_WRAP_SOUT 5
	#define MT8188_SOUT_DITHER0_TO_VPP_MERGE0  6
	#define MT8188_SOUT_DITHER0_TO_DP_INTF0 7


#define MT8188_VDO0_VPP_MERGE_SEL 0xf60
	#define MT8188_SEL_MERGE0_FROM_DSC_MOUT 0
	#define MT8188_SEL_MERGE0_FROM_SOUT_VDO1_VDO0 2
	#define MT8188_SEL_MERGE0_FROM_DITHER0 3

	#define MT8188_SOUT_MERGE0_O0_TO_DSI1 (0 << 4)
	#define MT8188_SOUT_MERGE0_O0_TO_DP_INTF0 (1 << 4)
    #define MT8188_SOUT_MERGE0_O0_TO_SINA_VDO0_VDO1 (2 << 4)
	#define MT8188_SOUT_MERGE0_O0_TO_DSC_WRAP0 (4 << 4)
	#define MT8188_SOUT_MERGE0_O0_TO_DISP_WDMA0 (5 << 4)

	#define MT8188_SOUT_MERGE0_O1_TO_DSC_WRAP0 (0 << 8)
	#define MT8188_SOUT_MERGE0_O1_TO_DISP_WDMA0 (1 << 8)


#define MT8188_VDO0_DSC_WRAP_SEL 0xf64
	#define MT8188_SEL_IN_DSC_WRAPC0_FROM_DITHER0 0
	#define MT8188_SEL_IN_DSC_WRAPC0_FROM_MERGE0_SOUT0 1

	#define MT8188_SEL_IN_DSC_WRAPC1_FROM_MERGE0_SOUT1 (1 << 4)

	#define MT8188_SEL_IN_DSC_WRAP_SOUT_FROM_DSC0 (0 << 8)
	#define MT8188_SEL_IN_DSC_WRAP_SOUT_FROM_DITHER0 (2 << 8)

	#define MT8188_MOUT_DSC_WRAP0C0_TO_DSI0  (1 << 16)
	#define MT8188_MOUT_DSC_WRAP0C0_TO_VDO0B_VDO1  (2 << 16)
	#define MT8188_MOUT_DSC_WRAP0C0_TO_DISP_WDMA0  (8 << 16)

	#define MT8188_SOUT_DSC_WRAP0C1_TO_DSI1        (0 << 24)
	#define MT8188_SOUT_DSC_WRAP0C1_TO_DP_INTF0    (1 << 24)
	#define MT8188_SOUT_DSC_WRAP0C1_TO_VDO0A_VDO1  (2 << 24)
	#define MT8188_SOUT_DSC_WRAP0C1_TO_MERGE0      (3 << 24)


#define MT8188_VDO0_RSZ_SEL  0xf68
	#define MT8188_SOUT_DISP_RSZ0_TO_OVL0     0
	#define MT8188_SOUT_DISP_RSZ0_TO_RDMA0    1

	#define MT8188_SEL_IN_DISP_RSZ0_FROM_OVL_PQ     (0 << 8)
	#define MT8188_SEL_IN_DISP_RSZ0_FROM_DISP_MOUT  (1 << 8)

#define MT8188_VDO0_DISP_WDMA_SEL  0xf6c
	#define MT8188_SEL_IN_WDMA0_FROM_OVL0_MOUT   0
	#define MT8188_SEL_IN_WDMA0_FROM_MERGE0_O1   1
	#define MT8188_SEL_IN_WDMA0_FROM_MERGE0_O0   2
	#define MT8188_SEL_IN_WDMA0_FROM_DSC_WRAP0_MOUT   3

#define MT8188_MUTEX_MOD_DISP_OVL0 BIT(0)
#define MT8188_MUTEX_MOD_DISP_WDMA0 BIT(1)
#define MT8188_MUTEX_MOD_DISP_RDMA0 BIT(2)
#define MT8188_MUTEX_MOD_DISP_COLOR0 BIT(3)
#define MT8188_MUTEX_MOD_DISP_CCORR0 BIT(4)
#define MT8188_MUTEX_MOD_DISP_AAL0 BIT(5)
#define MT8188_MUTEX_MOD_DISP_GAMMA0 BIT(6)
#define MT8188_MUTEX_MOD_DISP_DITHER0 BIT(7)
#define MT8188_MUTEX_MOD_DISP_DSI0 BIT(8)
#define MT8188_MUTEX_MOD_DISP_DSC_WRAP0_CORE0 BIT(9)
#define MT8188_MUTEX_MOD_DISP_OVL1 BIT(10)
#define MT8188_MUTEX_MOD_DISP_WDMA1 BIT(11)
#define MT8188_MUTEX_MOD_DISP_RDMA1 BIT(12)
#define MT8188_MUTEX_MOD_DISP_COLOR1 BIT(13)
#define MT8188_MUTEX_MOD_DISP_CCORR1 BIT(14)
#define MT8188_MUTEX_MOD_DISP_AAL1 BIT(15)
#define MT8188_MUTEX_MOD_DISP_GAMMA1 BIT(16)
#define MT8188_MUTEX_MOD_DISP_DITHER1 BIT(17)
#define MT8188_MUTEX_MOD_DISP_DSI1 BIT(18)
#define MT8188_MUTEX_MOD_DISP_DSC_WRAP0_CORE1 BIT(19)
#define MT8188_MUTEX_MOD_DISP_VPP_MERGE BIT(20)
#define MT8188_MUTEX_MOD_DISP_DP_INTF0 BIT(21)
#define MT8188_MUTEX_MOD_DISP1_DPI0 BIT(22)
#define MT8188_MUTEX_MOD_DISP1_DPI1 BIT(23)
#define MT8188_MUTEX_MOD_DISP_POSTMASK0 BIT(24)
#define MT8188_MUTEX_MOD_MDP_WROT0 BIT(25)
#define MT8188_MUTEX_MOD_DISP_RSZ0 BIT(26)
#define MT8188_MUTEX_MOD_DISP_VPP1_DL_RELAY0 BIT(27)
#define MT8188_MUTEX_MOD_DISP_VPP1_DL_RELAY1 BIT(28)
#define MT8188_MUTEX_MOD_DISP_VDO1_DL_RELAY2 BIT(29)
#define MT8188_MUTEX_MOD_DISP_VDO0_DL_RELAY3 BIT(30)
#define MT8188_MUTEX_MOD_DISP_VDO0_DL_RELAY4 BIT(31)

#define MT8188_MUTEX_MOD1_DISP_PWM0 BIT(32+0)
#define MT8188_MUTEX_MOD1_DISP_PWM1 BIT(32+1)
#define MT8188_MUTEX_MOD1_DISP1_DP_INTF0 BIT(32+7)

#define MT8188_DISP_MUTEX0_MOD0 0x30
#define MT8188_DISP_MUTEX0_MOD1 0x34

#define MT8188_DISP_MUTEX0_SOF 0x2C

#define MT8188_MUTEX_SOF_SINGLE_MODE 0
...
enum mtk_ddp_mutex_sof_id {
	...
	DDP_MUTEX_SOF_DSI2,
	DDP_MUTEX_SOF_DSI3,
	DDP_MUTEX_SOF_DP_INTF0,
	DDP_MUTEX_SOF_DP_INTF1,
	DDP_MUTEX_SOF_MAX,
};
...
struct mtk_disp_ddp_data {
	...
	unsigned int mutex_mod0_reg;
	unsigned int mutex_mod1_reg;
	unsigned int mutex_sof_reg;
	unsigned int one_path_second_mutex_id;
	const unsigned int *one_path_second_mutex_mod;
...
static const unsigned long mt6779_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6885_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6983_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6873_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6853_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6833_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt6879_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned int mt8195_dispsys_map[DDP_COMPONENT_ID_MAX] = {
	[DDP_COMPONENT_PSEUDO_OVL] = 1,
	[DDP_COMPONENT_ETHDR]      = 1,
	[DDP_COMPONENT_MERGE5]     = 1,
	[DDP_COMPONENT_DPI1]       = 1,
	[DDP_COMPONENT_DP_INTF1]   = 1,
};

static const unsigned int mt8188_dispsys_map[DDP_COMPONENT_ID_MAX] = {
	[DDP_COMPONENT_PSEUDO_OVL] = 1,
	[DDP_COMPONENT_ETHDR]      = 1,
	[DDP_COMPONENT_MERGE5]     = 1,
	[DDP_COMPONENT_DPI1]       = 1,
...
static const unsigned long mt8195_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	...
	/* To do: Across subsys mutex setting */
	/* MT8195_MUTEX_MOD_DISP_VPP1_DL_RELAY0 */
	/* MT8195_MUTEX_MOD_DISP_VPP1_DL_RELAY1 */
	/* MT8195_MUTEX_MOD_DISP_VDO1_DL_RELAY2 */
	/* MT8195_MUTEX_MOD_DISP_VDO0_DL_RELAY3 */
	[DDP_COMPONENT_SINA_VIRTUAL0] = MT8195_MUTEX_MOD_DISP_VDO0_DL_RELAY3,
	/* MT8195_MUTEX_MOD_DISP_VDO0_DL_RELAY4 */
	[DDP_COMPONENT_SINB_VIRTUAL0] = MT8195_MUTEX_MOD_DISP_VDO0_DL_RELAY4,
...
static const unsigned int
	mt8195_one_path_second_mutex_mod[DDP_COMPONENT_ID_MAX] = {
...
static const unsigned long mt8188_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		...
		[DDP_COMPONENT_CCORR0] = MT8188_MUTEX_MOD_DISP_CCORR0,
		[DDP_COMPONENT_AAL0] = MT8188_MUTEX_MOD_DISP_AAL0,
		[DDP_COMPONENT_GAMMA0] = MT8188_MUTEX_MOD_DISP_GAMMA0,
		...
		[DDP_COMPONENT_DMDP_WROT0] = MT8188_MUTEX_MOD_MDP_WROT0,
		[DDP_COMPONENT_MERGE0] = MT8188_MUTEX_MOD_DISP_VPP_MERGE |
			MT8188_MUTEX_MOD_DISP_VDO1_DL_RELAY2 |
			MT8188_MUTEX_MOD_DISP_VDO0_DL_RELAY3 |
			MT8188_MUTEX_MOD_DISP_VDO0_DL_RELAY4,
		[DDP_COMPONENT_DP_INTF0] = MT8188_MUTEX_MOD_DISP_DP_INTF0,
		[DDP_COMPONENT_RSZ0] = MT8188_MUTEX_MOD_DISP_RSZ0,
		[DDP_COMPONENT_PWM0] = MT8188_MUTEX_MOD1_DISP_PWM0,
		[DDP_COMPONENT_PWM1] = MT8188_MUTEX_MOD1_DISP_PWM1,
		[DDP_COMPONENT_PSEUDO_OVL] =
			VDO1_MUTEX_MOD0_MDP_RDMA0 |
			VDO1_MUTEX_MOD0_MDP_RDMA1 |
			VDO1_MUTEX_MOD0_MDP_RDMA2 |
			VDO1_MUTEX_MOD0_MDP_RDMA3 |
			VDO1_MUTEX_MOD0_MDP_RDMA4 |
			VDO1_MUTEX_MOD0_MDP_RDMA5 |
			VDO1_MUTEX_MOD0_MDP_RDMA6 |
			VDO1_MUTEX_MOD0_MDP_RDMA7 |
			VDO1_MUTEX_MOD0_DISP_PADDING0 |
			VDO1_MUTEX_MOD0_DISP_PADDING1 |
			VDO1_MUTEX_MOD0_DISP_PADDING2 |
			VDO1_MUTEX_MOD0_DISP_PADDING3 |
			VDO1_MUTEX_MOD0_DISP_PADDING4 |
			VDO1_MUTEX_MOD0_DISP_PADDING5 |
			VDO1_MUTEX_MOD0_DISP_PADDING6 |
			VDO1_MUTEX_MOD0_DISP_PADDING7 |
			VDO1_MUTEX_MOD0_DISP_RSZ0 |
			VDO1_MUTEX_MOD0_DISP_RSZ1 |
			VDO1_MUTEX_MOD0_DISP_RSZ2 |
			VDO1_MUTEX_MOD0_DISP_RSZ3 |
			VDO1_MUTEX_MOD0_DISP_MERGE0 |
			VDO1_MUTEX_MOD0_DISP_MERGE1 |
			VDO1_MUTEX_MOD0_DISP_MERGE2 |
			VDO1_MUTEX_MOD0_DISP_MERGE3 |
			VDO1_MUTEX_MOD0_VDO0_MERGE_DL_ASYNC |
			VDO1_MUTEX_MOD0_VDO1_OUT_DL_RELAY,
		[DDP_COMPONENT_ETHDR] = VDO1_MUTEX_MOD0_HDR_VDO_FE0 |
					VOD1_MUTEX_MOD1_HDR_VDO_FE1 |
					VOD1_MUTEX_MOD1_HDR_GFX_FE0 |
					VOD1_MUTEX_MOD1_HDR_GFX_FE1 |
					VOD1_MUTEX_MOD1_HDR_VDO_BE0 |
					VDO1_MUTEX_MOD0_DISP_MIXER  |
					VOD1_MUTEX_MOD1_HDR_MLOAD |
					VDO1_MUTEX_MOD1_HDR_VDO_FE0_ASYNC  |
					VDO1_MUTEX_MOD1_HDR_VDO_FE1_ASYNC  |
					VDO1_MUTEX_MOD1_HDR_GFX_FE0_ASYNC  |
					VDO1_MUTEX_MOD1_HDR_GFX_FE1_ASYNC  |
					VDO1_MUTEX_MOD1_HDR_VDO_BE0_ASYNC,
		[DDP_COMPONENT_MERGE5] = VDO1_MUTEX_MOD0_DISP_MERGE4,
		[DDP_COMPONENT_DPI1] = MT8188_MUTEX_MOD_DISP1_DPI1,
		[DDP_COMPONENT_DP_INTF1] = MT8188_MUTEX_MOD1_DISP1_DP_INTF0
};
...
static const unsigned int mt8195_mutex_sof[DDP_MUTEX_SOF_MAX] = {
	[DDP_MUTEX_SOF_SINGLE_MODE] = MT8195_MUTEX_SOF_SINGLE_MODE,
	[DDP_MUTEX_SOF_DSI0] = MT8195_MUTEX_SOF_DSI0 | MT8195_MUTEX_EOF_DSI0,
	[DDP_MUTEX_SOF_DPI0] = MT8195_MUTEX_SOF_DPI0 | MT8195_MUTEX_EOF_DPI0,
	[DDP_MUTEX_SOF_DSI1] = MT8195_MUTEX_SOF_DSI1 | MT8195_MUTEX_EOF_DSI1,
	[DDP_MUTEX_SOF_DPI1] = MT8195_MUTEX_SOF_DPI1 | MT8195_MUTEX_EOF_DPI1,
	[DDP_MUTEX_SOF_DP_INTF0] =
...
static const unsigned int mt8188_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		[DDP_MUTEX_SOF_SINGLE_MODE] = MT8188_MUTEX_SOF_SINGLE_MODE,
		[DDP_MUTEX_SOF_DSI0] = MT8188_MUTEX_SOF_DSI0 | MT8188_MUTEX_EOF_DSI0,
		[DDP_MUTEX_SOF_DPI1] = MT8195_MUTEX_SOF_DPI1 | MT8195_MUTEX_EOF_DPI1,
		[DDP_MUTEX_SOF_DP_INTF1] = MT8195_MUTEX_SOF_DP_INTF1 | MT8195_MUTEX_EOF_DP_INTF1,
};

static const struct mtk_disp_ddp_data mt2701_ddp_driver_data = {
	.mutex_mod = mt2701_mutex_mod,
	.mutex_sof = mt2701_mutex_sof,
	.mutex_mod0_reg = MT2701_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt2712_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT2712_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt8173_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT8173_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6779_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6779_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6885_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6885_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6983_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6983_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6873_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6873_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6853_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6853_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6833_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6833_DISP_MUTEX0_MOD0,
...
static const struct mtk_disp_ddp_data mt6879_ddp_driver_data = {
	...
	.mutex_mod0_reg = MT6879_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT6879_DISP_MUTEX0_SOF,
};

static const struct mtk_disp_ddp_data mt8195_ddp_driver_data = {
	.mutex_mod = mt8195_mutex_mod,
	.mutex_sof = mt8195_mutex_sof,
	.mutex_mod0_reg = MT8195_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT8195_DISP_MUTEX0_SOF,
	.one_path_second_mutex_id = 5,
	.one_path_second_mutex_mod = mt8195_one_path_second_mutex_mod,
	.dispsys_map = mt8195_dispsys_map,
};

static const struct mtk_disp_ddp_data mt8188_ddp_driver_data = {
	.mutex_mod = mt8188_mutex_mod,
	.mutex_sof = mt8188_mutex_sof,
	.mutex_mod0_reg = MT8188_DISP_MUTEX0_MOD0,
	.mutex_mod1_reg = MT8188_DISP_MUTEX0_MOD1,
	.mutex_sof_reg = MT8188_DISP_MUTEX0_SOF,
	.one_path_second_mutex_id = 0,
	.one_path_second_mutex_mod = NULL, // deprecated since 8188
	.dispsys_map = mt8195_dispsys_map, // same as 8195
};
...
const struct mtk_mmsys_reg_data mt8195_mmsys_reg_data = {
	// To-Do
	.ovl0_mout_en = MT8195_VDO0_OVL_MOUT_EN,
	.dispsys_map = mt8195_dispsys_map,
};

const struct mtk_mmsys_reg_data mt8188_mmsys_reg_data = {
	// To-Do
	.ovl0_mout_en = MT8188_VDO0_OVL_MOUT_EN,
	.dispsys_map = mt8188_dispsys_map,
};
...
static int mtk_ddp_mout_en_MT8195(
	...
	unsigned int *addr)
{
	...
	if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_RDMA0) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL0_TO_DISP_RDMA0;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_WDMA0) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL0_TO_DISP_WDMA0;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_OVL1) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL0_TO_DISP_OVL1;
	} else if (cur == DDP_COMPONENT_OVL1 && next == DDP_COMPONENT_RDMA1) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL1_TO_DISP_RDMA1;
	} else if (cur == DDP_COMPONENT_OVL1 && next == DDP_COMPONENT_WDMA1) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL1_TO_DISP_WDMA1;
	} else if (cur == DDP_COMPONENT_OVL1 && next == DDP_COMPONENT_OVL0) {
		*addr = MT8195_VDO0_OVL_MOUT_EN;
		value = MOUT_DISP_OVL1_TO_DISP_OVL0;
	}
	return value;
}

static int mtk_ddp_sel_in_MT8195(struct mtk_drm_crtc *mtk_crtc,
				 const struct mtk_mmsys_reg_data *data,
				 enum mtk_ddp_comp_id cur,
				 enum mtk_ddp_comp_id next, unsigned int *addr)
{
	int value;
	void __iomem *config_regs = mtk_crtc_get_regs(mtk_crtc, cur);

	if (cur == DDP_COMPONENT_DSC0 && next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_VPP_MERGE_FROM_DSC_WRAP0_OUT;
	} else if (cur == DDP_COMPONENT_DITHER1 &&
		   next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_VPP_MERGE_FROM_DISP_DITHER1;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		   next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_VPP_MERGE_FROM_VDO1_VIRTUAL0;
	} else if (cur == DDP_COMPONENT_DITHER0 && next == DDP_COMPONENT_DSC0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP0_IN_FROM_DISP_DITHER0;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSC0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP0_IN_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_DITHER1 && next == DDP_COMPONENT_DSC1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP1_IN_FROM_DISP_DITHER1;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSC1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP1_IN_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		   next == DDP_COMPONENT_SINA_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_SINA_VIRTUAL0_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_SINA_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_SINA_VIRTUAL0_FROM_DSC_WRAP1_OUT;
	} else if (cur == DDP_COMPONENT_DSC0 &&
		   next == DDP_COMPONENT_SINB_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_SINB_VIRTUAL0_FROM_DSC_WRAP0_OUT;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DP_INTF0_FROM_DSC_WRAP1_OUT;
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DP_INTF0_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DP_INTF0_FROM_VDO1_VIRTUAL0;
	} else if (cur == DDP_COMPONENT_DSC0 && next == DDP_COMPONENT_DSI0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSI0_FROM_DSC_WRAP0_OUT;
	} else if (cur == DDP_COMPONENT_DITHER0 && next == DDP_COMPONENT_DSI0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSI0_FROM_DISP_DITHER0;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DSI1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSI1_FROM_DSC_WRAP1_OUT;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSI1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSI1_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_OVL1 && next == DDP_COMPONENT_WDMA1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DISP_WDMA1_FROM_DISP_OVL1;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_WDMA1) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DISP_WDMA1_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_DSC1 &&
		   next == DDP_COMPONENT_DSC1_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP1_OUT_FROM_DSC_WRAP1_IN;
	} else if (cur == DDP_COMPONENT_DITHER1 &&
		   next == DDP_COMPONENT_DSC1_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DSC_WRAP1_OUT_FROM_DISP_DITHER1;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_WDMA0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DISP_WDMA0_FROM_DISP_OVL0;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_WDMA0) {
		*addr = MT8195_VDO0_SEL_IN;
		value = SEL_IN_DISP_WDMA0_FROM_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_PSEUDO_OVL &&
		   next == DDP_COMPONENT_ETHDR) {
		writel_relaxed(VPP_MERGE0_P0_SEL_IN_FROM_MDP_RDMA0,
			       config_regs + MT8195_VDO1_VPP_MERGE0_P0_SEL_IN);
		writel_relaxed(VPP_MERGE0_P1_SEL_IN_FROM_MDP_RDMA1,
			       config_regs + MT8195_VDO1_VPP_MERGE0_P1_SEL_IN);
		writel_relaxed(VPP_MERGE1_P0_SEL_IN_FROM_MDP_RDMA2,
			       config_regs + MT8195_VDO1_VPP_MERGE1_P0_SEL_IN);
		value = -1;
	} else if (cur == DDP_COMPONENT_ETHDR && next == DDP_COMPONENT_MERGE5) {
		writel_relaxed(MIXER_IN1_SEL_IN_FROM_HDR_VDO_FE0,
			       config_regs + MT8195_VDO1_MIXER_IN1_SEL_IN);
		writel_relaxed(MIXER_IN2_SEL_IN_FROM_HDR_VDO_FE1,
			       config_regs + MT8195_VDO1_MIXER_IN2_SEL_IN);
		writel_relaxed(MIXER_IN3_SEL_IN_FROM_HDR_GFX_FE0,
			       config_regs + MT8195_VDO1_MIXER_IN3_SEL_IN);
		writel_relaxed(MIXER_IN4_SEL_IN_FROM_HDR_GFX_FE1,
			       config_regs + MT8195_VDO1_MIXER_IN4_SEL_IN);
		writel_relaxed(MIXER_SOUT_SEL_IN_FROM_DISP_MIXER,
			       config_regs + MT8195_VDO1_MIXER_SOUT_SEL_IN);
		writel_relaxed(MERGE4_ASYNC_SEL_IN_FROM_HDR_VDO_BE0,
			       config_regs + MT8195_VDO1_MERGE4_ASYNC_SEL_IN);
		value = -1;
	} else if (cur == DDP_COMPONENT_MERGE5 && next == DDP_COMPONENT_DPI0) {
		*addr = MT8195_VDO1_DISP_DPI0_SEL_IN;
		value = DISP_DPI0_SEL_IN_FROM_VPP_MERGE4_MOUT;
	} else if (cur == DDP_COMPONENT_MERGE5 && next == DDP_COMPONENT_DPI1) {
		*addr = MT8195_VDO1_DISP_DPI1_SEL_IN;
		value = DISP_DPI1_SEL_IN_FROM_VPP_MERGE4_MOUT;
	} else if (cur == DDP_COMPONENT_MERGE5 &&
		   next == DDP_COMPONENT_DP_INTF1) {
		*addr = MT8195_VDO1_DISP_DP_INTF0_SEL_IN;
		value = DISP_DP_INTF0_SEL_IN_FROM_VPP_MERGE4_MOUT;
	} else {
		value = -1;
	}
...
static int mtk_ddp_sout_sel_MT8195(struct mtk_drm_crtc *mtk_crtc,
				   ...
				   unsigned int *addr)
{
	...
	if (cur == DDP_COMPONENT_DITHER0 && next == DDP_COMPONENT_DSC0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DISP_DITHER0_TO_DSC_WRAP0_IN;
	} else if (cur == DDP_COMPONENT_DITHER0 && next == DDP_COMPONENT_DSI0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DISP_DITHER0_TO_DSI0;
	} else if (cur == DDP_COMPONENT_DITHER1 && next == DDP_COMPONENT_DSC1) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DISP_DITHER1_TO_DSC_WRAP1_IN;
	} else if (cur == DDP_COMPONENT_DITHER1 &&
		   next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DISP_DITHER1_TO_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_DITHER1 &&
		   next == DDP_COMPONENT_DSC1_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DISP_DITHER1_TO_DSC_WRAP1_OUT;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		   next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VDO1_VIRTUAL0_TO_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VDO1_VIRTUAL0_TO_DP_INTF0;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSI1) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DSI1;
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DP_INTF0;
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		   next == DDP_COMPONENT_SINA_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_SINA_VIRTUAL0;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_WDMA1) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DISP_WDMA1;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSC0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DSC_WRAP0_IN;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_DSC1) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DSC_WRAP1_IN;
	} else if (cur == DDP_COMPONENT_MERGE0 && next == DDP_COMPONENT_WDMA0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_VPP_MERGE_TO_DISP_WDMA0;
	} else if (cur == DDP_COMPONENT_DSC0 && next == DDP_COMPONENT_DSI0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP0_OUT_TO_DSI0;
	} else if (cur == DDP_COMPONENT_DSC0 &&
		   next == DDP_COMPONENT_SINB_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP0_OUT_TO_SINB_VIRTUAL0;
	} else if (cur == DDP_COMPONENT_DSC0 && next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP0_OUT_TO_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DSI1) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP1_OUT_TO_DSI1;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP1_OUT_TO_DP_INTF0;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_SINA_VIRTUAL0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP1_OUT_TO_SINA_VIRTUAL0;
	} else if (cur == DDP_COMPONENT_DSC1_VIRTUAL0 &&
		   next == DDP_COMPONENT_MERGE0) {
		*addr = MT8195_VDO0_SEL_OUT;
		value = SOUT_DSC_WRAP1_OUT_TO_VPP_MERGE;
	} else if (cur == DDP_COMPONENT_PSEUDO_OVL &&
		   next == DDP_COMPONENT_ETHDR) {
		writel_relaxed(SOUT_TO_VPP_MERGE0_P1_SEL,
			       config_regs + MT8195_VDO1_VPP3_ASYNC_SOUT);
		writel_relaxed(SOUT_TO_HDR_VDO_FE0,
			       config_regs + MT8195_VDO1_MERGE0_ASYNC_SOUT_SEL);
		writel_relaxed(SOUT_TO_HDR_VDO_FE1,
			       config_regs + MT8195_VDO1_MERGE1_ASYNC_SOUT_SEL);
		writel_relaxed(SOUT_TO_HDR_GFX_FE0,
			       config_regs + MT8195_VDO1_MERGE2_ASYNC_SOUT_SEL);
		writel_relaxed(SOUT_TO_HDR_GFX_FE1,
			       config_regs + MT8195_VDO1_MERGE3_ASYNC_SOUT_SEL);
		value = -1;
	} else if (cur == DDP_COMPONENT_ETHDR && next == DDP_COMPONENT_MERGE5) {
		writel_relaxed(MIXER_IN1_SOUT_TO_DISP_MIXER,
			       config_regs + MT8195_VDO1_MIXER_IN1_SOUT_SEL);
		writel_relaxed(MIXER_IN2_SOUT_TO_DISP_MIXER,
			       config_regs + MT8195_VDO1_MIXER_IN2_SOUT_SEL);
		writel_relaxed(MIXER_IN3_SOUT_TO_DISP_MIXER,
			       config_regs + MT8195_VDO1_MIXER_IN3_SOUT_SEL);
		writel_relaxed(MIXER_IN4_SOUT_TO_DISP_MIXER,
			       config_regs + MT8195_VDO1_MIXER_IN4_SOUT_SEL);
		writel_relaxed(MIXER_SOUT_TO_HDR_VDO_BE0,
			       config_regs + MT8195_VDO1_MIXER_OUT_SOUT_SEL);
		value = -1;
	} else if (cur == DDP_COMPONENT_MERGE5 && next == DDP_COMPONENT_DPI1) {
		*addr = MT8195_VDO1_MERGE4_SOUT_SEL;
		value = MERGE4_SOUT_TO_DPI1_SEL;
	} else if (cur == DDP_COMPONENT_MERGE5 && next == DDP_COMPONENT_DPI0) {
		*addr = MT8195_VDO1_MERGE4_SOUT_SEL;
		value = MERGE4_SOUT_TO_DPI0_SEL;
	} else if (cur == DDP_COMPONENT_MERGE5 &&
		   next == DDP_COMPONENT_DP_INTF1) {
		*addr = MT8195_VDO1_MERGE4_SOUT_SEL;
		value = MERGE4_SOUT_TO_DP_INTF0_SEL;
	} else {
		value = -1;
	}
...
static int mtk_ddp_mout_en_MT8188(
	enum mtk_ddp_comp_id cur,
	enum mtk_ddp_comp_id next,
	unsigned int *addr)
{
	...
	if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_RDMA0) {
		*addr = MT8188_VDO0_OVL_MOUT_EN;
		value = MT8188_MOUT_DISP_OVL0_TO_DISP_RDMA0;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_WDMA0) {
		*addr = MT8188_VDO0_OVL_MOUT_EN;
		value = MT8188_MOUT_DISP_OVL0_TO_DISP_WDMA0;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_RSZ0) {
		*addr = MT8188_VDO0_OVL_MOUT_EN;
		value = MT8188_MOUT_DISP_OVL0_TO_DISP_RSZ0;
	} else if (cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_DMDP_WROT0) {
		*addr = MT8188_VDO0_OVL_MOUT_EN;
		value = MT8188_MOUT_DISP_OVL1_TO_DISP_WROT0;
	}

	if (value < 0)
		value = mtk_vdo1_mout_en(cur, next, addr);

	return value;
}

static int mtk_ddp_sel_in_MT8188(struct mtk_drm_crtc *mtk_crtc,
	const struct mtk_mmsys_reg_data *reg_data,
	enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
	unsigned int *addr)
{
	...
	if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DISP_RDMA0_FROM_OVL0);
	} else if (cur == DDP_COMPONENT_DSC0 &&
		next == DDP_COMPONENT_MERGE0) {
		*addr = MT8188_VDO0_DSC_WRAP_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DSC_WRAP_SOUT_FROM_DSC0);
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		next == DDP_COMPONENT_MERGE0) {
		value = -1;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		...
		*addr = MT8188_VDO0_DSC_WRAP_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DSC_WRAPC0_FROM_DITHER0);
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		next == DDP_COMPONENT_DSC0) {
		*addr = MT8188_VDO0_DSC_WRAP_SEL;
		value = MT8188_SEL_IN_DSC_WRAPC0_FROM_MERGE0_SOUT0;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8188_VDO0_DSI0_SEL;
		value = MT8188_SEL_IN_DISP_DSI0_FROM_RDMA0;
	} else if (cur == DDP_COMPONENT_DSC0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8188_VDO0_DSI0_SEL;
		value = MT8188_SEL_IN_DISP_DSI0_FROM_DSC_MOUT;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8188_VDO0_DSI0_SEL;
		value = MT8188_SEL_IN_DISP_DSI0_FROM_DITHER0;
	} else if (cur == DDP_COMPONENT_MERGE0 &&
		next == DDP_COMPONENT_DSI1) {
		*addr = MT8188_VDO0_DSI1_SEL;
		value = MT8188_SEL_IN_DISP_DSI1_FROM_MERGE0;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT8188_VDO0_DISP_WDMA_SEL;
		value = MT8188_SEL_IN_WDMA0_FROM_OVL0_MOUT;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT8188_VDO0_RSZ_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DISP_RSZ0_FROM_OVL_PQ);
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8188_VDO0_RSZ_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DISP_RSZ0_FROM_DISP_MOUT);
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SEL_IN_DISP_RDMA0_FROM_RSZ0);
	}

	if (value < 0)
		value = mtk_vdo1_sel_in(mtk_crtc, cur, next, addr);

	return value;
}

static int mtk_ddp_sout_sel_MT8188(struct mtk_drm_crtc *mtk_crtc,
	const struct mtk_mmsys_reg_data *data,
	enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
	unsigned int *addr)
{
	...
	if (cur == DDP_COMPONENT_RDMA0 &&
		...
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RDMA_TO_DISP_COLOR0);
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RDMA_TO_DSI0);
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI1) {
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RDMA_TO_DSI1);
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DP_INTF0) {
		*addr = MT8188_VDO0_DISP_RDMA_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RDMA_TO_DP_INTF0);
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT8188_VDO0_RSZ_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RSZ0_TO_OVL0);
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT8188_VDO0_RSZ_SEL;
		value = (readl_relaxed(config_regs + *addr) |
			MT8188_SOUT_DISP_RSZ0_TO_RDMA0);
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DSC0) {
		*addr = MT8188_VDO0_DISP_DITHER0_SEL;
		value = MT8188_SOUT_DITHER0_TO_DSC_WRAP0;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT8188_VDO0_DISP_DITHER0_SEL;
		value = MT8188_SOUT_DITHER0_TO_DSI0;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
		next == DDP_COMPONENT_MERGE0) {
		value = -1;
	} else if (cur == DDP_COMPONENT_VDO1_VIRTUAL0 &&
	...
	if (value < 0)
		value = mtk_vdo1_sout_sel(mtk_crtc, cur, next);
			      ...
			      enum mtk_ddp_comp_id next)
{
	...
	DDPDBG("%s(crtc-%d): curr=%d, prev=%d next=%d, reg=%p\n",
		__func__, crtc_id, cur, prev, next, config_regs);
	...
	case MMSYS_MT8195:
		value = mtk_ddp_mout_en_MT8195(cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sout_sel_MT8195(mtk_crtc, reg_data, cur, next,
						&addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		...
		value = mtk_ddp_sel_in_MT8195(mtk_crtc, reg_data, cur, next,
					      &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		...
		break;
	case MMSYS_MT8188:
		value = mtk_ddp_mout_en_MT8188(cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sout_sel_MT8188(
			mtk_crtc, reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sel_in_MT8188(
			mtk_crtc, reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
					...
					struct cmdq_pkt *handle)
{
	...
	const struct mtk_mmsys_reg_data *reg_data = mtk_crtc->mmsys_reg_data;
	struct mtk_drm_private *priv = mtk_crtc->base.dev->dev_private;
	resource_size_t regs_pa = mtk_crtc_get_regs_pa(mtk_crtc, cur);
	int crtc_id = drm_crtc_index(&mtk_crtc->base);

	DDPDBG("%s(crtc-%d): curr=%d, next=%d, reg=%lx\n",
		__func__, crtc_id, cur, next, regs_pa);
	...
	case MMSYS_MT6983:
		cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
			regs_pa + MT6983_BYPASS_MUX_SHADOW, 0x1, ~0);
	...
	case MMSYS_MT8195:
		...
		value = mtk_ddp_sout_sel_MT8195(
			mtk_crtc, mtk_crtc->mmsys_reg_data, cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				       regs_pa + addr, value, ~0);

		value = mtk_ddp_sel_in_MT8195(
			mtk_crtc, mtk_crtc->mmsys_reg_data, cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				       regs_pa + addr, value, ~0);
				   ...
				   enum mtk_ddp_comp_id next)
{
	...
	DDPDBG("%s(crtc-%d): reg=%p, curr=%d, next=%d\n",
		__func__, crtc_id, config_regs, cur, next);
...
void mtk_ddp_insert_dsc_prim_MT8195(struct mtk_drm_crtc *mtk_crtc,
				    struct cmdq_pkt *handle)
{
	unsigned int addr, value;

	/* DISP_DITHER_OUT -> DISP_DSC_IN -> DISP_DSC_OUT -> DSI_IN */
	addr = MT8195_VDO0_SEL_IN;
	value = (SEL_IN_DSC_WRAP0_IN_FROM_DISP_DITHER0 |
		 SEL_IN_DSI0_FROM_DSC_WRAP0_OUT);
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value,
		       (BIT(4) | BIT(16)));

	addr = MT8195_VDO0_SEL_OUT;
	value = (SOUT_DISP_DITHER0_TO_DSC_WRAP0_IN |
		 SOUT_DSC_WRAP0_OUT_TO_DSI0);
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value,
		       (BIT(0) | BIT(12) | BIT(13)));
}

void mtk_ddp_remove_dsc_prim_MT8195(struct mtk_drm_crtc *mtk_crtc,
				    struct cmdq_pkt *handle)
{
	unsigned int addr, value;

	/* DISP_DITHER_OUT -> DSI_SEL_IN */
	addr = MT8195_VDO0_SEL_IN;
	value = SEL_IN_DSI0_FROM_DISP_DITHER0;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
	...
	/* DISP_DITHER1_OUT -> DSI1_SEL_IN */
	addr = MT8195_VDO0_SEL_IN;
	value = (SEL_IN_DSI0_FROM_DISP_DITHER0 |
		 SEL_IN_DSI1_FROM_DSC_WRAP1_OUT |
		 SEL_IN_DSC_WRAP1_OUT_FROM_DISP_DITHER1);
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT8195_VDO0_SEL_OUT;
	value = (SOUT_DISP_DITHER0_TO_DSI0 |
		 SOUT_DISP_DITHER1_TO_DSC_WRAP1_OUT |
		 SOUT_DSC_WRAP1_OUT_TO_DSI1);
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
}

static struct mtk_ddp *mtk_ddp_get(struct mtk_drm_crtc *mtk_crtc,
				   struct mtk_disp_mutex *mutex)
{
	struct mtk_disp_mutex *curr_mutex = NULL;
	struct mtk_ddp *ddp = NULL;

	if (mtk_crtc == NULL || mutex == NULL) {
		DDPAEE("%s(): NULL pointer\n", __func__);
		goto end;
	}
	...
	if (ddp == NULL) {
		DDPAEE("%s(): failed to find the container\n", __func__);
		goto end;
	}

	curr_mutex = &ddp->mutex[mutex->id];

	if (curr_mutex != mutex) {
		DDPAEE("%s(): invalid mutex[%d] 0x%p, should be 0x%p\n",
			__func__, mutex->id, curr_mutex, mutex);
		WARN_ON(1);
	}
end:
	return ddp;
...
static struct clk *mtk_ddp_clk_get(struct mtk_drm_crtc *mtk_crtc,
				   struct mtk_ddp *ddp)
{
	return mtk_crtc->use_second_mutex ? ddp->side_clk : ddp->clk;
}
...
mtk_ddp_get_mmsys_reg_data(enum mtk_mmsys_id mmsys_id)
{
	...
	case MMSYS_MT6879:
		...
		break;
	case MMSYS_MT8195:
		data = &mt8195_mmsys_reg_data;
		break;
	case MMSYS_MT8188:
		data = &mt8188_mmsys_reg_data;
		break;
	default:
	...
	unsigned int pipe)
{
	...
	struct mtk_disp_mutex *mutex = ddp->mutex;

	DDPDBG("%s(crtc-%d)\n", __func__, pipe);

	if (mutex == NULL) {
		DDPDBG("%s(): error: NULL mutex\n", __func__);
	...
	mutex[i].claimed = true;

	DDPDBG("%s(crtc-%d): return 0x%p\n", __func__, pipe, &mutex[i]);
...
int mtk_disp_mutex_prepare(struct mtk_drm_crtc *mtk_crtc,
			   struct mtk_disp_mutex *mutex)
{
	struct mtk_ddp *ddp = mtk_ddp_get(mtk_crtc, mutex);
	struct clk *clk = mtk_ddp_clk_get(mtk_crtc, ddp);
	...
	unsigned int offset)
{
	...
	if (mod_id)
		mod = mod >> 32; // cast to int

	value = readl_relaxed(addr + offset);

	if (unset)
		value &= (unsigned int)(~mod);
	else
		value |= (unsigned int)mod;
...
void mutex_mod_add(
	...
	unsigned int offset)
{
	mutex_mod_update(0, mod_id, mod_value, addr, offset);
}

void mutex_mod_remove(
	bool mod_id,
	unsigned long mod_value,
	void __iomem *addr,
	unsigned int offset)
{
	mutex_mod_update(1, mod_id, mod_value, addr, offset);
}

void mutex_mod_update_cmdq(
	bool unset,
	bool mod_id,
	unsigned long mod_value,
	...
	struct mtk_drm_crtc *mtk_crtc)
{
	...
	value = (unsigned int) mod;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		addr + offset, unset ? ~value : value, value);
}

void mutex_mod_add_cmdq(
	bool mod_id,
	unsigned long mod_value,
	resource_size_t addr,
	unsigned int offset,
	...
	struct mtk_drm_crtc *mtk_crtc)
{
	mutex_mod_update_cmdq(0, mod_id, mod_value, addr, offset, handle, mtk_crtc);
}

void mutex_mod_remove_cmdq(
	bool mod_id,
	unsigned long mod_value,
	resource_size_t addr,
	unsigned int offset,
	...
	struct mtk_drm_crtc *mtk_crtc)
{
	mutex_mod_update_cmdq(1, mod_id, mod_value, addr, offset, handle, mtk_crtc);
}
			     ...
			     enum mtk_ddp_comp_id id)
{
	...
	if (ddp->data->dispsys_map &&
	    ddp->data->dispsys_map[id])
		addr = ddp->side_regs;
	else
		addr = ddp->regs;

	offset = DISP_REG_MUTEX_MOD0(ddp->data, mutex->id);
	mutex_mod_add(0, ddp->data->mutex_mod[id], addr, offset);

	offset = DISP_REG_MUTEX_MOD1(ddp->data, mutex->id);
	mutex_mod_add(1, ddp->data->mutex_mod[id], addr, offset);

	if (mtk_crtc->one_path_two_mutex_en) {
		offset = DISP_REG_MUTEX_MOD0(ddp->data,
					ddp->data->one_path_second_mutex_id);
		mutex_mod_add(0, ddp->data->one_path_second_mutex_mod[id],
			addr, offset);

		offset = DISP_REG_MUTEX_MOD1(ddp->data,
					ddp->data->one_path_second_mutex_id);
		mutex_mod_add(1, ddp->data->one_path_second_mutex_mod[id],
			addr, offset);
	}
}
...
void mtk_disp_mutex_src_set(struct mtk_drm_crtc *mtk_crtc, bool is_cmd_mode)
{
		...
		if (mtk_crtc->one_path_two_mutex_en) {
			writel_relaxed(
				ddp->data->mutex_sof[val] |
					(MUTEX_SOF_TIMING_VSYNC_RISING_EDGE
					 << REG_FLD_SHIFT(
						    SOF_FLD_MUTEX0_SOF_TIMING)),
				ddp->side_regs +
					DISP_REG_MUTEX_SOF(
						ddp->data,
						ddp->data->one_path_second_mutex_id));
	...
	case DDP_COMPONENT_DP_INTF1:
		val = DDP_MUTEX_SOF_DP_INTF1;
		break;

	default:
		DDPDBG("%s(): undefined source: %d\n", __func__, id);
	}
	...
	if (mtk_crtc->use_second_mutex) {
#ifdef IFZERO // what are these for ?
		...
		DDPMSG("%s, dual id:%d, val:0x%x\n",
			__func__, id, ddp->data->mutex_sof[val]);
		writel_relaxed(ddp->data->mutex_sof[val],
			ddp->side_regs + DISP_REG_MUTEX_SOF(ddp->data, mutex->id));
	}
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		writel_relaxed(ddp->data->mutex_sof[val]|
				(MUTEX_SOF_TIMING_VSYNC_RISING_EDGE<<
				REG_FLD_SHIFT(SOF_FLD_MUTEX0_SOF_TIMING)),
				   ddp->side_regs + DISP_REG_MUTEX_SOF(ddp->data,
				   ddp->data->one_path_second_mutex_id));
	}
}
				       ...
				       unsigned int mutex_id)
{
	...
	DDPDBG("%s(crtc-%d): add component %d to mutex %d\n",
		__func__, crtc_id, id, mutex_id);
	...
	ddp = mtk_ddp_get(mtk_crtc, mutex);
	mod = ddp->data->mutex_mod[id] > BIT(31);
	...
	default:
		offset = DISP_REG_MUTEX_MOD0(ddp->data, mutex->id);
		mutex_mod_add_cmdq(0, ddp->data->mutex_mod[id],
			addr, offset, handle, mtk_crtc);

		offset = DISP_REG_MUTEX_MOD1(ddp->data, mutex->id);
		mutex_mod_add_cmdq(1, ddp->data->mutex_mod[id],
			addr, offset, handle, mtk_crtc);

		if (mtk_crtc->one_path_two_mutex_en) {
			offset = DISP_REG_MUTEX_MOD0(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_add_cmdq(0, ddp->data->one_path_second_mutex_mod[id],
				addr, offset, handle, mtk_crtc);

			offset = DISP_REG_MUTEX_MOD1(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_add_cmdq(1, ddp->data->one_path_second_mutex_mod[id],
				addr, offset, handle, mtk_crtc);
		}
	...
	offset = DISP_REG_MUTEX_SOF(ddp->data, mutex->id);
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       addr + offset,
		       ddp->data->mutex_sof[reg], ~0);

	if (mtk_crtc->one_path_two_mutex_en) {
		offset = DISP_REG_MUTEX_SOF(ddp->data,
					ddp->data->one_path_second_mutex_id);
		cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
			addr + offset,
			ddp->data->mutex_sof[reg],
			REG_FLD_MASK(SOF_FLD_MUTEX0_SOF));
	}
}
				...
				enum mtk_ddp_comp_id id)
{
	...
	unsigned int offset;
	void __iomem *addr;
	bool mod = ddp->data->mutex_mod[id] > BIT(31);
	int crtc_id = drm_crtc_index(&mtk_crtc->base);

	DDPDBG("%s(crtc-%d): remove component %d from mutex %d\n",
		__func__, crtc_id, id, mutex->id);
	DDPDBG("%s(crtc-%d): mutex of the component = %lx (mod: %d)\n",
		__func__, crtc_id, ddp->data->mutex_mod[id], mod);
	...
	case DDP_COMPONENT_DPI1:
		writel_relaxed(
			...
			addr + DISP_REG_MUTEX_SOF(ddp->data, mutex->id));
	...
	default:
		offset = DISP_REG_MUTEX_MOD0(ddp->data, mutex->id);
		mutex_mod_remove(0, ddp->data->mutex_mod[id], addr, offset);

		offset = DISP_REG_MUTEX_MOD1(ddp->data, mutex->id);
		mutex_mod_remove(1, ddp->data->mutex_mod[id], addr, offset);

		if (mtk_crtc->one_path_two_mutex_en) {
			offset = DISP_REG_MUTEX_MOD0(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_remove(0, ddp->data->one_path_second_mutex_mod[id],
				addr, offset);

			offset = DISP_REG_MUTEX_MOD1(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_remove(1, ddp->data->one_path_second_mutex_mod[id],
				addr, offset);
		}
		break;
	}
					  ...
					  unsigned int mutex_id)
{
	...
	default:
		offset = DISP_REG_MUTEX_MOD0(ddp->data, mutex->id);
		mutex_mod_remove_cmdq(0, ddp->data->mutex_mod[id],
			addr, offset, handle, mtk_crtc);

		offset = DISP_REG_MUTEX_MOD1(ddp->data, mutex->id);
		mutex_mod_remove_cmdq(1, ddp->data->mutex_mod[id],
			addr, offset, handle, mtk_crtc);

		if (mtk_crtc->one_path_two_mutex_en) {
			offset = DISP_REG_MUTEX_MOD0(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_remove_cmdq(0, ddp->data->one_path_second_mutex_mod[id],
				addr, offset, handle, mtk_crtc);

			offset = DISP_REG_MUTEX_MOD1(ddp->data,
						ddp->data->one_path_second_mutex_id);
			mutex_mod_remove_cmdq(1, ddp->data->one_path_second_mutex_mod[id],
				addr, offset, handle, mtk_crtc);
		}
		break;
	}
...
void mtk_disp_mutex_trigger(struct mtk_drm_crtc *mtk_crtc,
			    struct mtk_disp_mutex *mutex, void *handle)
{
	struct mtk_ddp *ddp = mtk_ddp_get(mtk_crtc, mutex);
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		cmdq_pkt_write(handle, ddp->cmdq_base,
			ddp->side_regs_pa + DISP_REG_MUTEX_EN(
			ddp->data->one_path_second_mutex_id),
			1, ~0);
	}
}

void mtk_disp_mutex_inten_enable(struct mtk_drm_crtc *mtk_crtc,
				 struct mtk_disp_mutex *mutex)
{
	struct mtk_ddp *ddp = mtk_ddp_get(mtk_crtc, mutex);
	unsigned int val;
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		val |= (0x1
			<< (unsigned int)ddp->data->one_path_second_mutex_id);
		val |= (0x1
			<< (unsigned int)(ddp->data->one_path_second_mutex_id +
					  DISP_MUTEX_TOTAL));
	}
			   ...
			   struct mtk_disp_mutex *mutex)
{
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		writel(1, ddp->side_regs + DISP_REG_MUTEX_EN(
			ddp->data->one_path_second_mutex_id));
	}
	mtk_disp_mutex_inten_enable(mtk_crtc, mutex);
}
				...
				struct cmdq_base *cmdq_base)
{
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		cmdq_pkt_write(cmdq_handle, cmdq_base,
			ddp->side_regs_pa + DISP_REG_MUTEX_EN(
			ddp->data->one_path_second_mutex_id), 1, ~0);
	}
	mtk_disp_mutex_inten_enable_cmdq(mtk_crtc, mutex, cmdq_handle);
}
...
{
	struct mtk_ddp *ddp = mtk_ddp_get(mtk_crtc, mutex);
	unsigned int offset = DISP_REG_MUTEX_EN(mutex->id);

	if (mtk_crtc->use_first_mutex)
		writel(0, ddp->regs + offset);

	if (mtk_crtc->use_second_mutex)
		writel(0, ddp->side_regs + offset);

	if (mtk_crtc->one_path_two_mutex_en) {
		writel(0, ddp->side_regs + DISP_REG_MUTEX_EN(
			ddp->data->one_path_second_mutex_id));
	}

	if (mutex->id == 2) {
		offset = DISP_REG_MUTEX_RST(mutex->id);
		if (mtk_crtc->use_first_mutex)
			writel(1, ddp->regs + offset);
		if (mtk_crtc->use_second_mutex)
			writel(1, ddp->side_regs + offset);
		udelay(1);
		if (mtk_crtc->use_first_mutex)
			writel(0, ddp->regs + offset);
		if (mtk_crtc->use_second_mutex)
			    ...
			    struct mtk_disp_mutex *mutex)
{
	...
	if (mtk_crtc->use_first_mutex) {
		...
		if (readl_poll_timeout_atomic(ddp->regs +
			DISP_REG_MUTEX(mutex->id),
			tmp, tmp & INT_MUTEX, 1, 10000))
			DDPDBG("could not acquire mutex %d\n", mutex->id);
	}

	if (mtk_crtc->use_second_mutex) {
		writel(1, ddp->side_regs + DISP_REG_MUTEX_EN(mutex->id));
		writel(1, ddp->side_regs + DISP_REG_MUTEX(mutex->id));
		if (readl_poll_timeout_atomic(ddp->side_regs +
			DISP_REG_MUTEX(mutex->id),
			tmp, tmp & INT_MUTEX, 1, 10000))
			DDPDBG("could not acquire mutex %d\n", mutex->id);
	}
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		writel(1, ddp->side_regs + DISP_REG_MUTEX_EN(
			ddp->data->one_path_second_mutex_id));
		writel(1, ddp->side_regs + DISP_REG_MUTEX(
			ddp->data->one_path_second_mutex_id));
		if (readl_poll_timeout_atomic(ddp->side_regs +
			DISP_REG_MUTEX(ddp->data->one_path_second_mutex_id),
			tmp, tmp & INT_MUTEX, 1, 10000))
			DDPMSG("could not acquire mutex %d\n",
				ddp->data->one_path_second_mutex_id);
	}
}
			    ...
			    struct mtk_disp_mutex *mutex)
{
	...
	if (mtk_crtc->one_path_two_mutex_en) {
		writel(0, ddp->side_regs + DISP_REG_MUTEX(
			ddp->data->one_path_second_mutex_id));
	}
}
			       ...
			       struct mtk_disp_mutex *mutex)
{
	struct mtk_ddp *ddp = mtk_ddp_get(mtk_crtc, mutex);
	struct mtk_drm_private *priv = mtk_crtc->base.dev->dev_private;
	unsigned int mask, value, offset;
	...
	DDPDBG("%s(crtc-%d): offset=%x, mask=%x\n",
		__func__, drm_crtc_index(&mtk_crtc->base), offset, mask);

	if (mtk_crtc->use_first_mutex) {
		value = readl_relaxed(ddp->regs + offset) & mask;
		writel(value, ddp->regs + offset);
	}

	if (mtk_crtc->use_second_mutex) {
		value = readl_relaxed(ddp->side_regs + offset) & mask;
		writel(value, ddp->side_regs + offset);
	}

	if (mtk_crtc->one_path_two_mutex_en) { // 8195 only
		mask = 0xff8f;
		offset = DISP_REG_MUTEX_SOF(
			ddp->data, ddp->data->one_path_second_mutex_id);
		value = readl_relaxed(ddp->side_regs + offset) & mask;
		value |= MUTEX_SOF_TIMING_VSYNC_RISING_EDGE
		      << REG_FLD_SHIFT(SOF_FLD_MUTEX0_SOF_TIMING);
		writel(value, ddp->side_regs + offset);
	}
}
...
void mutex_dump_analysis_mt6885(struct mtk_disp_mutex *mutex)
{
	...
	for (i = 0; i < 5; i++) {
		...
		if (readl_relaxed(ddp->regs +
				  DISP_REG_MUTEX_MOD0(ddp->data, i)) == 0)
			continue;
		...
		mod0 = readl_relaxed(ddp->regs +
			DISP_REG_MUTEX_MOD0(ddp->data, i));
		for (j = 0; j < 32; j++) {
			if ((mod0 & (1 << j))) {
				len = sprintf(p, "%s,",
		...
		mod1 = readl_relaxed(ddp->regs +
			DISP_REG_MUTEX_MOD1(ddp->data, mutex->id));
		for (j = 0; j < 32; j++) {
			if ((mod1 & (1 << j))) {
				len = sprintf(p, "%s,",
	...
	for (i = 0; i < 5; i++) {
		...
		for (j = 0; j < 32; j++) {
			unsigned int regval = readl_relaxed(
				ddp->regs + DISP_REG_MUTEX_MOD0(ddp->data, i));
...
static int mtk_ddp_probe(struct platform_device *pdev)
{
	...
	DDPDBG("%s(): ddp->regs_pa = %llx\n", __func__, ddp->regs_pa);
	DDPDBG("%s(): ddp->regs = %p\n", __func__, ddp->regs);
	...
	ddp->side_regs_pa = regs->start;
	ddp->side_regs = devm_ioremap_resource(dev, regs);
	if (IS_ERR(ddp->side_regs)) {
		dev_err(dev, "Failed to map mutex registers\n");
		return PTR_ERR(ddp->side_regs);
	}

	DDPDBG("%s(): ddp->side_regs_pa = %llx\n", __func__, ddp->side_regs_pa);
	DDPDBG("%s(): ddp->side_regs = %p\n", __func__, ddp->side_regs);

	ddp->side_clk = of_clk_get(dev->of_node, 1);
	if (IS_ERR(ddp->side_clk))
		pr_info("Failed to get the side clock\n");
...
static const struct of_device_id ddp_driver_dt_match[] = {
	...
	{.compatible = "mediatek,mt8195-disp-mutex",
	 .data = &mt8195_ddp_driver_data},
	{.compatible = "mediatek,mt8188-disp-mutex",
	 .data = &mt8188_ddp_driver_data},
	{},
};
