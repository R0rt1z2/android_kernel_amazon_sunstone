...
#define DPI_MATRIX_COEF_00		0xB8
#define MATRIX_COEF_00			0
#define MATRIX_COEF_00_MASK		(0x7FFF << 0)
#define MATRIX_COEF_01			16
#define MATRIX_COEF_01_MASK		(0x7FFF << 16)

#define DPI_MATRIX_COEF_02		0xBC
#define MATRIX_COEF_02			0
#define MATRIX_COEF_02_MASK		(0x7FFF << 0)
#define MATRIX_COEF_10			16
#define MATRIX_COEF_10_MASK		(0x7FFF << 16)

#define DPI_MATRIX_COEF_11		0xC0
#define MATRIX_COEF_11			0
#define MATRIX_COEF_11_MASK		(0x7FFF << 0)
#define MATRIX_COEF_12			16
#define MATRIX_COEF_12_MASK		(0x7FFF << 16)

#define DPI_MATRIX_COEF_20		0xC4
#define MATRIX_COEF_20			0
#define MATRIX_COEF_20_MASK		(0x7FFF << 0)
#define MATRIX_COEF_21			16
#define MATRIX_COEF_21_MASK		(0x7FFF << 16)

#define DPI_MATRIX_COEF_22		0xC8
#define MATRIX_COEF_22			0
#define MATRIX_COEF_22_MASK		(0x7FFF << 0)

#define DPI_MATRIX_IN_OFFSET_0		0xCC
#define MATRIX_IN_OFFSET_0		0
#define MATRIX_IN_OFFSET_0_MASK		(0x7FF << 0)
#define MATRIX_IN_OFFSET_1		16
#define MATRIX_IN_OFFSET_1_MASK		(0x7FF << 16)

#define DPI_MATRIX_IN_OFFSET_2		0xD0
#define MATRIX_IN_OFFSET_2		0
#define MATRIX_IN_OFFSET_2_MASK		(0x7FF << 0)

#define DPI_MATRIX_OUT_OFFSET_0		0xD4
#define MATRIX_OUT_OFFSET_0		0
#define MATRIX_OUT_OFFSET_0_MASK	(0x7FF << 0)
#define MATRIX_OUT_OFFSET_1		16
#define MATRIX_OUT_OFFSET_1_MASK	(0x7FF << 16)

#define DPI_MATRIX_OUT_OFFSET_2		0xD8
#define MATRIX_OUT_OFFSET_2			0
#define MATRIX_OUT_OFFSET_2_MASK	(0x7FF << 0)
...
#define VDOSYS1_SW0_RST		0x1D0
#define DPI_SW_RST			(0x1 << 23)
