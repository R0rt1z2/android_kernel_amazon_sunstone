...
#define PRIMARY_SESSION_INPUT_LAYER_COUNT (7) /* phy(4) + ext(3) */
...
#define SECONDARY_DISP_ID 2
#else
#define SECONDARY_DISP_ID 1
#endif
...
enum DISP_HW_MAPPING_TB_TYPE {
	...
	DISP_HW_LARB_TB,
	DISP_HW_LAYER_TB,
	DISP_HW_LAYER_YUV_ONLY_TB,
	DISP_HW_LAYER_RGB_ONLY_TB,
};
