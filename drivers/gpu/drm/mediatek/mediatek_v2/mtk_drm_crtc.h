...
#define MAX_CRTC 3
#define CRTC_ID_PRIMARY  0
#define CRTC_ID_EXTERNAL 1
#define CRTC_ID_VIRTUAL  2

#define OVL_LAYER_NR 12L
#define OVL_PHY_LAYER_NR 4L
#define RDMA_LAYER_NR 1UL
#define EXTERNAL_INPUT_LAYER_NR 4UL

#ifdef CONFIG_MTK_WFD_OVER_VDO1
#define MEMORY_INPUT_LAYER_NR 4UL
#else
...
struct mtk_drm_crtc {
	...
	bool use_first_mutex;
	bool use_second_mutex;
	bool one_path_two_mutex_en;
