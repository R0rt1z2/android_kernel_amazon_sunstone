...
static int regulator_trace_consumers(struct regulator_dev *rdev, int qos_class)
{
	...
	list_for_each_entry(regulator, &rdev->consumer_list, list) {
		...
		trace_mtk_pm_qos_regulator_update_request(qos_class,
							  voltage->min_uV / 1000,
							  devname);
	}
	return 0;
...
static const unsigned int mt8188_voltages[] = {
	550000,
	600000,
	650000,
	725000,
...
static struct dvfsrc_regulator mt8188_regulators[] = {
	MT_DVFSRC_REGULAR("dvfsrc-vcore", VCORE,
			  mt8188_voltages),
	MT_DVFSRC_REGULAR("dvfsrc-vscp", VSCP,
			  mt8188_voltages),
...
static const struct dvfsrc_regulator_init_data regulator_mt8188_data = {
	.size = ARRAY_SIZE(mt8188_regulators),
	.regulator_info = &mt8188_regulators[0],
};
