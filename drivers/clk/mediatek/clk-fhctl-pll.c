...
/* 8188 begin */
#define SIZE_8188_TOP (sizeof(mt8188_top_data)\
	/sizeof(struct fh_pll_data))
#define DATA_8188_TOP(_name) {				\
		.name = _name,						\
		.dds_mask = GENMASK(21, 0),			\
		.slope0_value = 0x6003c97,			\
		.slope1_value = 0x6003c97,			\
...
#define OFFSET_8188_TOP(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_hp_en = 0x0,				\
		.offset_clk_con = 0x8,				\
...
static struct fh_pll_data mt8188_top_data[] = {
	DATA_8188_TOP("armpll_ll"),
	DATA_8188_TOP("armpll_bl"),
	DATA_8188_TOP("ccipll"),
	DATA_8188_TOP("msdcpll"),
	DATA_8188_TOP("tvdpll1"),
	DATA_8188_TOP("tvdpll2"),
	DATA_8188_TOP("mempll"),
	DATA_8188_TOP("mpll"),
	DATA_8188_TOP("mmpll"),
	DATA_8188_TOP("mainpll"),
	DATA_8188_TOP("imgpll"),
	DATA_8188_TOP("adsppll"),
	DATA_8188_TOP("mfgpll"),
	{}
};
static struct fh_pll_offset mt8188_top_offset[] = {
	OFFSET_8188_TOP(0x003C, 0x0208),  // FHCTL0_CFG, ARMPLL_LL_CON1
	OFFSET_8188_TOP(0x0050, 0x0218),  // FHCTL1_CFG, ARMPLL_BL_CON1
	OFFSET_8188_TOP(0x0064, 0x0228),  // FHCTL2_CFG, CCIPLL_CON1
	OFFSET_8188_TOP(0x0078, 0x0518),  // FHCTL3_CFG, MSDCPLL_CON1
	OFFSET_8188_TOP(0x008C, 0x0528),  // FHCTL4_CFG, TVDPLL1_CON1
	OFFSET_8188_TOP(0x00A0, 0x0538),  // FHCTL5_CFG, TVDPLL2_CON1
	OFFSET_8188_TOP(0x00B4, 0xffff),  // FHCTL6_CFG,
	OFFSET_8188_TOP(0x00C8, 0x0440),  // FHCTL7_CFG, MPLL_CON1
	OFFSET_8188_TOP(0x00DC, 0x0548),  // FHCTL8_CFG, MMPLL_CON1
	OFFSET_8188_TOP(0x00F0, 0x0460),  // FHCTL9_CFG, MAINPLL_CON1
	OFFSET_8188_TOP(0x0104, 0x0558),  // FHCTL10_CFG, IMGPLL_CON1
	OFFSET_8188_TOP(0x0118, 0x0430),  // FHCTL11_CFG, ADSPPLL_CON1
	OFFSET_8188_TOP(0x012c, 0x0344),  // FHCTL12_CFG, MFGPLL_CON1
	{}
};
static struct fh_pll_regs mt8188_top_regs[SIZE_8188_TOP];
static struct fh_pll_domain mt8188_top = {
	.name = "top",
	.data = (struct fh_pll_data *)&mt8188_top_data,
	.offset = (struct fh_pll_offset *)&mt8188_top_offset,
	.regs = (struct fh_pll_regs *)&mt8188_top_regs,
	.init = &init_v1,
};
static struct fh_pll_domain *mt8188_domain[] = {
	&mt8188_top,
	NULL,
};
static struct match mt8188_match = {
	.compatible = "mediatek,mt8188-fhctl",
	.domain_list = (struct fh_pll_domain **)mt8188_domain,
};
/* 8188 end */
