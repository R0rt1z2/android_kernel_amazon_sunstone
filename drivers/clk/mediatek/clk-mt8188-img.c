...
static const struct mtk_gate imgsys_main_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS_MAIN_LARB9, "imgsys_main_larb9", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_TRAW0, "imgsys_main_traw0", "img_sel", 1),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_TRAW1, "imgsys_main_traw1", "img_sel", 2),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_VCORE_GALS, "imgsys_main_vcore_gals", "img_sel", 3),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_DIP0, "imgsys_main_dip0", "img_sel", 8),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_WPE0, "imgsys_main_wpe0", "img_sel", 9),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_IPE, "imgsys_main_ipe", "img_sel", 10),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_WPE1, "imgsys_main_wpe1", "img_sel", 12),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_WPE2, "imgsys_main_wpe2", "img_sel", 13),
	GATE_IMGSYS(CLK_IMGSYS_MAIN_GALS, "imgsys_main_gals", "img_sel", 31),
};

static const struct mtk_gate imgsys_wpe1_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS_WPE1_LARB11, "imgsys_wpe1_larb11", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS_WPE1, "imgsys_wpe1", "img_sel", 1),
};

static const struct mtk_gate imgsys_wpe2_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS_WPE2_LARB11, "imgsys_wpe2_larb11", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS_WPE2, "imgsys_wpe2", "img_sel", 1),
};

static const struct mtk_gate imgsys_wpe3_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS_WPE3_LARB11, "imgsys_wpe3_larb11", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS_WPE3, "imgsys_wpe3", "img_sel", 1),
};

static const struct mtk_gate imgsys1_dip_top_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS1_DIP_TOP_LARB10, "imgsys1_dip_larb10", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS1_DIP_TOP_DIP_TOP, "imgsys1_dip_dip_top", "img_sel", 1),
};

static const struct mtk_gate imgsys1_dip_nr_clks[] = {
	GATE_IMGSYS(CLK_IMGSYS1_DIP_NR_LARB15, "imgsys1_dip_nr_larb15", "img_sel", 0),
	GATE_IMGSYS(CLK_IMGSYS1_DIP_NR_DIP_NR, "imgsys1_dip_nr_dip_nr", "img_sel", 1),
};
