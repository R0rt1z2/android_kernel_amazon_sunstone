...
#define CMDQ_THREAD_SEC_PRIMARY_MEMOUT	(CMDQ_MIN_SECURE_THREAD_ID)
#define CMDQ_THREAD_SEC_PRIMARY_DISP	(CMDQ_MIN_SECURE_THREAD_ID + 1)
#define CMDQ_THREAD_SEC_MDP_0		(CMDQ_MIN_SECURE_THREAD_ID + 4)
#define CMDQ_THREAD_SEC_MDP_1		(CMDQ_MIN_SECURE_THREAD_ID + 5)
...
typedef s32(*CmdqResourceReleaseCB) (u16 resourceEvent);
...
struct ResourceUnitStruct {
	...
	u16 lockEvent;	/* SW token to lock in GCE thread */
...
struct cmdqRecStruct {
	...
	s32 reorder;
	CMDQ_TIME submit;
	CMDQ_TIME transInstrBeg;
	CMDQ_TIME transInstrEnd;
	CMDQ_TIME trigger;
	CMDQ_TIME beginWait;
	CMDQ_TIME gotIRQ;
	CMDQ_TIME wakedUp;
	...
	u32 instrCount;	/* instruction count passed form userspace */
	u32 durAlloc;	/* allocae time duration */
	u32 durReclaim;	/* allocae time duration */
	u32 durRelease;	/* release time duration */
