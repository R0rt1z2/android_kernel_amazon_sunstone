...
extern void cmdq_sec_setup_tee_context(struct cmdq_sec_tee_context *tee);
extern s32 cmdq_sec_init_context(struct cmdq_sec_tee_context *tee);
extern s32 cmdq_sec_allocate_wsm(struct cmdq_sec_tee_context *tee,
	void **wsm_buffer, u8 idx, u32 size);
extern s32 cmdq_sec_open_session(struct cmdq_sec_tee_context *tee, void *wsm_buffer);
extern s32 cmdq_sec_execute_session(struct cmdq_sec_tee_context *tee,
