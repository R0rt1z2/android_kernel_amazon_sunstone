...
#define CMDQ_MAX_SECURE_THREAD_COUNT	(6)
#define CMDQ_MIN_SECURE_THREAD_ID	(7)
...
#define CMDQ_THREAD_SEC_SUB_DISP	(CMDQ_MIN_SECURE_THREAD_ID + 3)
#define CMDQ_THREAD_SEC_MDP_0		(CMDQ_MIN_SECURE_THREAD_ID + 4)
#define CMDQ_THREAD_SEC_MDP_1		(CMDQ_MIN_SECURE_THREAD_ID + 5)
#define CMDQ_THREAD_SEC_ISP		CMDQ_INVALID_THREAD /* not used currently */
