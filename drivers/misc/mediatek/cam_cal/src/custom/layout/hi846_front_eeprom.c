...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000001, 0x01015857, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000761, 0x0000000A, do_2a_gain_front},
		{0x00000000, 0x00000763, 0x00000800, do_pdaf},
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000000, 0x00000000, 0x0000077C, do_dump_all},
		{0x00000000, 0x00000F80, 0x0000000A, do_lens_id}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT hi846_front_eeprom = {
	.name = "hi846_front_eeprom",
