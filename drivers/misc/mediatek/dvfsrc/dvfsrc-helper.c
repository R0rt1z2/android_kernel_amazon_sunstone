...
static struct dvfsrc_opp dvfsrc_opp_mt8195_lp4[] = {
	{0, 0, 0, 0},
	{1, 0, 0, 0},
	{2, 0, 0, 0},
	{3, 0, 0, 0},
...
static struct dvfsrc_opp_desc dvfsrc_opp_mt8195_desc[] = {
	MT_DVFSRC_OPP(4, 7, dvfsrc_opp_mt8195_lp4),
};

static const struct dvfsrc_debug_data mt8195_data = {
	.version = 0x8195,
	.config = &mt6873_dvfsrc_config,
	.opps_desc = dvfsrc_opp_mt8195_desc,
	.num_opp_desc = ARRAY_SIZE(dvfsrc_opp_mt8195_desc),
};
