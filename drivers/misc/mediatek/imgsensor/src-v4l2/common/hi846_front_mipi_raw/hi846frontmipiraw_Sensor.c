...
#include "hi846frontmipiraw_Sensor.h"
#include "hi846_front_ana_gain_table.h"
...
#define PFX "HI846_front_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_FRONT_SENSOR_ID,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(ctx, 0x0f17) << 8)
				      | read_cmos_sensor_8(ctx, 0x0f16)) + 2;
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(hi846_front_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)hi846_front_ana_gain_table,
			sizeof(hi846_front_ana_gain_table));
		}
		break;
...
const struct subdrv_entry hi846_front_mipi_raw_entry = {
	.name = "hi846_front_mipi_raw",
	.id = HI846_FRONT_SENSOR_ID,
	.pw_seq = pw_seq,
