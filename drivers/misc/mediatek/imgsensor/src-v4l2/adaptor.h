...
#define MTK_CAM_DUAL_PIPE_DPTZ_SUPPORT MTKCAM_VSDOF_SINGLE_CAMERA_SUPPORT

//=================================================
// Sub + Main2 open
#define DUALSENID_1ST        0x217
#define DUALSENID_2ND        0x216
//=================================================

#define DPD_CTR_GET      0
#define DPD_CTR_RELEASE  1
#define DPD_CTRL_ACTIVE  1
#define DPD_CTRL_PASS    0
