...
static const struct proc_ops perfmgr_tb_enable_fops = {
	.proc_open = perfmgr_tb_enable_open,
	.proc_write = perfmgr_tb_enable_write,
	.proc_read = seq_read,
...
static const struct proc_ops perfmgr_tb_freq_fops = {
	.proc_open = perfmgr_tb_freq_open,
	.proc_write = perfmgr_tb_freq_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
