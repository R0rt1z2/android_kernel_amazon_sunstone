...
enum ReeServiceCommand {
	...
	REE_SERV_GET_WFD_CHUNK_MEMPOOL,
	REE_SERV_REL_WFD_CHUNK_MEMPOOL,
	REE_SERV_GET_SVP_CHUNK_MEMPOOL,
	REE_SERV_REL_SVP_CHUNK_MEMPOOL,
...
struct ree_service_thrd {
	uint32_t handle;	/* thread handle */
	char name[MTEE_THREAD_NAME_NUM];	/* kree side, thread name */
};
