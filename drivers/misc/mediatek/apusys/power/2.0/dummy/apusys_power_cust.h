...
#define DVFS_ASSERTION_CHECK	(0)
#define VCORE_DVFS_SUPPORT	(0)
#define ASSERTION_PERCENTAGE	(0)	// 1%
...
#define APUSYS_PATH_USER_NUM		(2)   // num of DVFS_XXX_PATH
#define APUSYS_DVFS_CONSTRAINT_NUM	(2)
#define APUSYS_VPU_NUM			(2)
#define APUSYS_MDLA_NUM			(2)
#define APUSYS_DEFAULT_OPP		(0)
#define APUSYS_INVALID_OPP		(0xFF)
#define APUSYS_ACC_NUM			(0)
//#define APUSYS_POWER_OFF_KEEP_OPP
