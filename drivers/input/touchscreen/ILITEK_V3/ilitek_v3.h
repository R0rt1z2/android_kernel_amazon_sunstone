...
#define TPSWITCH_HOVER_BIT (BIT(0) | BIT(4))
#define MAX_PRESSURE                                                           \
...
enum TP_PLAT_TYPE { TP_PLAT_MTK = 0, TP_PLAT_CORE };
...
enum TP_FW_BLOCK_TAG { BLOCK_TAG_AF = 0xAF, BLOCK_TAG_B0 = 0xB0 };
...
#define TOUCH_SCREEN_X_MAX 1200
#define TOUCH_SCREEN_Y_MAX 2000
...
#define P5_X_HAND_PEN_TYPE 0x39
#define P5_X_ONLY_PEN_TYPE 0x3F
#define P5_X_ONLY_HAND_TYPE 0xF9
#endif
...
#define TDDI_WHOLE_CHIP_RST_WITHOUT_FLASH_KEY 0xA0019878 // COFFEE
...
#if ENABLE_PEN_MODE
#define POSITION_CUSTOMER_TYPE_OFF 0x07
...
#if ENABLE_PEN_MODE
extern void ili_pen_demo_mode_report_point(u8 *buf, int len, u16 offset);
...
#if ENABLE_CASCADE
extern void ili_set_bypass_mode(void);
extern int ili_slave_ic_get_info(void);
...
extern void ili_check_enable_cascade(void);
extern void ili_wdt_reset_status(bool enter_ice, bool exit_ice);
extern int ili_cascade_rw_tp_reg(u32 mcu, u32 type, u32 addr, u32 wdata,
				 u32 wlen, u32 *rdata);
...
#if ENABLE_PEN_MODE
extern int ili_set_pen_data_info(u8 header, u8 ctrl, u8 type);
#endif
...
extern void ili_sysfs_remove_group(struct ilitek_ts_data *ts);
