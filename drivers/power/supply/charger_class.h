...
struct charger_ops {
	...
	int (*get_indpm_state)(struct charger_device *dev, bool *vdpm, bool *idpm);
	...
	int (*enable_dcap)(struct charger_device *dev, bool en);
};
...
extern int charger_dev_get_indpm_state(struct charger_device *charger_dev,
	bool *vdpm, bool *idpm);
...
/* Disable charger auto power-on */
extern int charger_dev_enable_dcap(struct charger_device *dev, bool en);
extern int set_shutdown_enable_dcap(void);
