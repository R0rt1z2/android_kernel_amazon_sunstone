...
/* BATTERY_ID_NUM_MAX <= TOTAL_BATTERY_NUMBER*/
#define BATTERY_ID_NUM_MAX 4
/* min bat_temp -10° */
#define DISABLE_LOW_BATTERY_TEMP (-10)
...
//timotodo
	...
	int battery_id;
	int battery_id_volt;
	int battery_id_volt_min;
	int battery_id_volt_max;
	int battery_id_method;
	int total_battery_number;
	int gauge_battery_id_voltage[BATTERY_ID_NUM_MAX + 1];
	const char *bat_name[BATTERY_ID_NUM_MAX];
	int fake_rtc_soc;
...
extern int battery_report_uevent(struct mtk_battery *gm);
/*mtk_battery.c end */
