...
#include <dt-bindings/reset-controller/mt8188-resets.h>
...
static const struct mtk_wdt_data mt8188_data = {
	.rst_num = MT8188_TOPRGU_SW_RST_NUM,
};
...
static int mtk_wdt_start(struct watchdog_device *wdt_dev)
{
	...
	reg |= (WDT_MODE_EXRST_EN | WDT_MODE_IRQ_LVL | WDT_MODE_EXT_POL_LOW);
...
static const struct proc_ops wk_proc_cmd_fops = {
	.proc_open = wk_proc_cmd_open,
	.proc_read = seq_read,
	.proc_write = wk_proc_cmd_write,
