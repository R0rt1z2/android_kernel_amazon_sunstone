...
long mtk_cam_v4l2_compat_ioctl32(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	if (ret == -ENOIOCTLCMD)
		pr_err("mtk_cam_v4l2_compat_ioctl32: unknown ioctl '%c', dir=%d, #%d (0x%08x)\n",
...
static const struct v4l2_file_operations mtk_cam_v4l2_fops = {
	...
	.mmap = vb2_fop_mmap,
#ifdef CONFIG_COMPAT
	.compat_ioctl32 = mtk_cam_v4l2_compat_ioctl32,
#endif
};
