...
long mtk_imgsys_v4l2_compat_ioctl32(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	if (ret == -ENOIOCTLCMD)
		pr_err( "mtk_imgsys_v4l2_compat_ioctl32: unknown ioctl '%c', dir=%d, #%d (0x%08x)\n",
