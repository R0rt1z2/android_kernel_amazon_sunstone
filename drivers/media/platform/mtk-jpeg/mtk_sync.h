...
/**
 * struct mtk_v4l2_fence_data - mtk v4l2 fence data
 * @base: software synchronization primitive
 * @sync_file: synce file to export to the userspace
 * @fence_fd: the integer variable associate with the dma fence
 * @length[VIDEO_MAX_PLANES]: the associated buffer planes size
 */

struct mtk_v4l2_fence_data {
	struct dma_fence base;
	struct sync_file *sync_file;
	int fence_fd;
	u32 length[MAX_PLANES];
};
