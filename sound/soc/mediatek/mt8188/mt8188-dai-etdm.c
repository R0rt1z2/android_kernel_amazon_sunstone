...
static int is_cowork_mode(struct snd_soc_dai *dai)
{
	...
	if (dai->id < MT8188_AFE_IO_ETDM_START ||
	    dai->id >= MT8188_AFE_IO_ETDM_END) {
		dev_dbg(dai->dev, "%s invalid dai id\n", __func__);
		return 0;
	}
...
static const struct snd_kcontrol_new mtk_dai_etdm_o048_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I096 Switch", AFE_CONN48_3, 0, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I098 Switch", AFE_CONN48_3, 2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I100 Switch", AFE_CONN48_3, 4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I102 Switch", AFE_CONN48_3, 6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I104 Switch", AFE_CONN48_3, 8, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I106 Switch", AFE_CONN48_3, 10, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I108 Switch", AFE_CONN48_3, 12, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I110 Switch", AFE_CONN48_3, 14, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I112 Switch", AFE_CONN48_3, 16, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I114 Switch", AFE_CONN48_3, 18, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I116 Switch", AFE_CONN48_3, 20, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I118 Switch", AFE_CONN48_3, 22, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o049_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I097 Switch", AFE_CONN49_3, 1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I099 Switch", AFE_CONN49_3, 3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I101 Switch", AFE_CONN49_3, 5, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I103 Switch", AFE_CONN49_3, 7, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I105 Switch", AFE_CONN49_3, 9, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I107 Switch", AFE_CONN49_3, 11, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I109 Switch", AFE_CONN49_3, 13, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I111 Switch", AFE_CONN49_3, 15, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I113 Switch", AFE_CONN49_3, 17, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I115 Switch", AFE_CONN49_3, 19, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I117 Switch", AFE_CONN49_3, 21, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I119 Switch", AFE_CONN49_3, 23, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o050_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I098 Switch", AFE_CONN50_3, 2, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o051_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I099 Switch", AFE_CONN51_3, 3, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o052_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I100 Switch", AFE_CONN52_3, 4, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o053_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I101 Switch", AFE_CONN53_3, 5, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o054_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I102 Switch", AFE_CONN54_3, 6, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o055_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I103 Switch", AFE_CONN55_3, 7, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o056_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I104 Switch", AFE_CONN56_3, 8, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o057_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I105 Switch", AFE_CONN57_3, 9, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o058_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I106 Switch", AFE_CONN58_3, 10, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o059_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I107 Switch", AFE_CONN59_3, 11, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o060_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I108 Switch", AFE_CONN60_3, 12, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o061_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I109 Switch", AFE_CONN61_3, 13, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o062_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I110 Switch", AFE_CONN62_3, 14, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o063_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I111 Switch", AFE_CONN63_3, 15, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o072_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I004 Switch", AFE_CONN72, 4, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I098 Switch", AFE_CONN72_3, 2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I100 Switch", AFE_CONN72_3, 4, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I102 Switch", AFE_CONN72_3, 6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I104 Switch", AFE_CONN72_3, 8, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I106 Switch", AFE_CONN72_3, 10, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I108 Switch", AFE_CONN72_3, 12, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I110 Switch", AFE_CONN72_3, 14, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I112 Switch", AFE_CONN72_3, 16, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I114 Switch", AFE_CONN72_3, 18, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I116 Switch", AFE_CONN72_3, 20, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I118 Switch", AFE_CONN72_3, 22, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o073_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I005 Switch", AFE_CONN73, 5, 1, 0),
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I097 Switch", AFE_CONN73_3, 1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I099 Switch", AFE_CONN73_3, 3, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I101 Switch", AFE_CONN73_3, 5, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I103 Switch", AFE_CONN73_3, 7, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I105 Switch", AFE_CONN73_3, 9, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I107 Switch", AFE_CONN73_3, 11, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I109 Switch", AFE_CONN73_3, 13, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I111 Switch", AFE_CONN73_3, 15, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I113 Switch", AFE_CONN73_3, 17, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I115 Switch", AFE_CONN73_3, 19, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I117 Switch", AFE_CONN73_3, 21, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I119 Switch", AFE_CONN73_3, 23, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o074_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I006 Switch", AFE_CONN74, 6, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I024 Switch", AFE_CONN74, 24, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I048 Switch", AFE_CONN74_1, 16, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I098 Switch", AFE_CONN74_3, 2, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o075_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I007 Switch", AFE_CONN75, 7, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I025 Switch", AFE_CONN75, 25, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I049 Switch", AFE_CONN75_1, 17, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I099 Switch", AFE_CONN75_3, 3, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o076_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I008 Switch", AFE_CONN76, 8, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I026 Switch", AFE_CONN76, 26, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I050 Switch", AFE_CONN76_1, 18, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I100 Switch", AFE_CONN76_3, 4, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o077_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I009 Switch", AFE_CONN77, 9, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I027 Switch", AFE_CONN77, 27, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I051 Switch", AFE_CONN77_1, 19, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I101 Switch", AFE_CONN77_3, 5, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o078_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I010 Switch", AFE_CONN78, 10, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I028 Switch", AFE_CONN78, 28, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I052 Switch", AFE_CONN78_1, 20, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I102 Switch", AFE_CONN78_3, 6, 1, 0),
};

static const struct snd_kcontrol_new mtk_dai_etdm_o079_mix[] = {
	SOC_DAPM_SINGLE_AUTODISABLE("I011 Switch", AFE_CONN79, 11, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I029 Switch", AFE_CONN79, 29, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I053 Switch", AFE_CONN79_1, 21, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("I103 Switch", AFE_CONN79_3, 7, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o080_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I104 Switch", AFE_CONN80_3, 8, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o081_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I105 Switch", AFE_CONN81_3, 9, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o082_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I106 Switch", AFE_CONN82_3, 10, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o083_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I107 Switch", AFE_CONN83_3, 11, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o084_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I108 Switch", AFE_CONN84_3, 12, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o085_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I109 Switch", AFE_CONN85_3, 13, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o086_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I110 Switch", AFE_CONN86_3, 14, 1, 0),
};
...
static const struct snd_kcontrol_new mtk_dai_etdm_o087_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("I111 Switch", AFE_CONN87_3, 15, 1, 0),
};
...
static const char * const mt8188_etdmin_loopback_text[] = {
...
static SOC_ENUM_SINGLE_EXT_DECL(etdmin_loopback_src_enum,
	mt8188_etdmin_loopback_text);

static const char * const mt8188_etdmin_slv_clk_text[] = {
	ENUM_TO_STR(ETDM_IN_SLAVE_FROM_PAD),
	ENUM_TO_STR(ETDM_IN_SLAVE_FROM_ETDM_OUT1),
	ENUM_TO_STR(ETDM_IN_SLAVE_FROM_ETDM_OUT2),
	ENUM_TO_STR(ETDM_IN_SLAVE_FROM_ETDM_OUT3),
};

static SOC_ENUM_SINGLE_EXT_DECL(etdmin_slv_clk_enum,
	mt8188_etdmin_slv_clk_text);

static const char * const mt8188_etdmout_slv_clk_text[] = {
	ENUM_TO_STR(ETDM_OUT_SLAVE_FROM_PAD),
	ENUM_TO_STR(ETDM_OUT_SLAVE_FROM_ETDM_IN1),
	ENUM_TO_STR(ETDM_OUT_SLAVE_FROM_ETDM_IN2),
};

static SOC_ENUM_SINGLE_EXT_DECL(etdmout_slv_clk_enum,
	mt8188_etdmout_slv_clk_text);
...
static int mt8188_etdmin_lpbk_src_put(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_IN1_Loopback_Source")) {
		if (source == ETDM_IN_FROM_PAD)
			value = COWORK_ETDM_IN1_M;
		else if (source == ETDM_IN_FROM_ETDM_OUT1)
			value = COWORK_ETDM_OUT1_M;
		else if (source == ETDM_IN_FROM_ETDM_OUT2)
			value = COWORK_ETDM_OUT2_M;
		else if (source == ETDM_IN_FROM_ETDM_OUT3)
			value = COWORK_ETDM_OUT3_M;
		reg = ETDM_COWORK_CON1;
		mask = (ETDM_IN1_SDATA0_SEL_MASK | ETDM_IN1_SDATA_SEL_MASK);
		val = ((ETDM_IN1_SDATA0_SEL_MASK & ETDM_IN1_SDATA0_SEL(value)) |
			(ETDM_IN1_SDATA_SEL_MASK & ETDM_IN1_SDATA_SEL(value)));
	} else if (!strcmp(kcontrol->id.name, "ETDM_IN2_Loopback_Source"))  {
		if (source == ETDM_IN_FROM_PAD)
			value = COWORK_ETDM_IN2_M;
		else if (source == ETDM_IN_FROM_ETDM_OUT1)
			value = COWORK_ETDM_OUT1_M;
		else if (source == ETDM_IN_FROM_ETDM_OUT2)
			value = COWORK_ETDM_OUT2_M;
			...
			value = COWORK_ETDM_OUT3_M;
		reg = ETDM_COWORK_CON3;
		mask = (ETDM_IN2_SDATA0_SEL_MASK | ETDM_IN2_SDATA_SEL_MASK);
		val = ((ETDM_IN2_SDATA0_SEL_MASK & ETDM_IN2_SDATA0_SEL(value)) |
			(ETDM_IN2_SDATA_SEL_MASK & ETDM_IN2_SDATA_SEL(value)));
	}
	if (reg)
		regmap_update_bits(afe->regmap, reg, mask, val);
...
static int mt8188_etdmin_lpbk_src_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_IN1_Loopback_Source")) {
		...
		shift = ETDM_IN1_SDATA0_SEL_SHIFT;
	} else if (!strcmp(kcontrol->id.name, "ETDM_IN2_Loopback_Source")) {
		reg = ETDM_COWORK_CON3;
		mask = ETDM_IN2_SDATA0_SEL_MASK;
		shift = ETDM_IN2_SDATA0_SEL_SHIFT;
	}
	...
	if (value == COWORK_ETDM_OUT1_M)
		ucontrol->value.enumerated.item[0] = ETDM_IN_FROM_ETDM_OUT1;
	else if (value == COWORK_ETDM_OUT2_M)
		ucontrol->value.enumerated.item[0] = ETDM_IN_FROM_ETDM_OUT2;
	else if (value == COWORK_ETDM_OUT3_M)
		ucontrol->value.enumerated.item[0] = ETDM_IN_FROM_ETDM_OUT3;
	else
		ucontrol->value.enumerated.item[0] = ETDM_IN_FROM_PAD;
	return 0;
}

static int mt8188_etdmin_slv_clk_put(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_IN1_Slave_Clock_Source")) {
		if (source == ETDM_IN_SLAVE_FROM_PAD)
			value = COWORK_ETDM_IN1_S;
		else if (source == ETDM_IN_SLAVE_FROM_ETDM_OUT1)
			value = COWORK_ETDM_OUT1_M;
		else if (source == ETDM_IN_SLAVE_FROM_ETDM_OUT2)
			value = COWORK_ETDM_OUT2_M;
		else if (source == ETDM_IN_SLAVE_FROM_ETDM_OUT3)
			value = COWORK_ETDM_OUT3_M;
		reg = ETDM_COWORK_CON1;
		mask = ETDM_IN1_SLAVE_SEL_MASK;
		val = ETDM_IN1_SLAVE_SEL(value);
	} else if (!strcmp(kcontrol->id.name, "ETDM_IN2_Slave_Clock_Source")) {
		if (source == ETDM_IN_SLAVE_FROM_PAD)
			value = COWORK_ETDM_IN2_S;
		else if (source == ETDM_IN_SLAVE_FROM_ETDM_OUT1)
			value = COWORK_ETDM_OUT1_M;
		else if (source == ETDM_IN_SLAVE_FROM_ETDM_OUT2)
			value = COWORK_ETDM_OUT2_M;
...
static int mt8188_etdmin_slv_clk_get(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_IN1_Slave_Clock_Source")) {
		reg = ETDM_COWORK_CON1;
		mask = ETDM_IN1_SLAVE_SEL_MASK;
		shift = ETDM_IN1_SLAVE_SEL_SHIFT;
	} else if (!strcmp(kcontrol->id.name, "ETDM_IN2_Slave_Clock_Source")) {
		reg = ETDM_COWORK_CON2;
		mask = ETDM_IN2_SLAVE_SEL_MASK;
		shift = ETDM_IN2_SLAVE_SEL_SHIFT;
	}
...
static int mt8188_etdmout_slv_clk_put(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_OUT1_Slave_Clock_Source")) {
		if (source == ETDM_OUT_SLAVE_FROM_PAD)
			value = COWORK_ETDM_OUT1_S;
		else if (source == ETDM_OUT_SLAVE_FROM_ETDM_IN1)
			value = COWORK_ETDM_IN1_M;
		else if (source == ETDM_OUT_SLAVE_FROM_ETDM_IN2)
			value = COWORK_ETDM_IN2_M;
		reg = ETDM_COWORK_CON0;
		mask = ETDM_OUT1_SLAVE_SEL_MASK;
		val = ETDM_OUT1_SLAVE_SEL(value);
		regmap_update_bits(afe->regmap, reg, mask, val);

		ret = get_etdm_reg(MT8188_AFE_IO_ETDM1_OUT, &etdm_reg);
		if (ret < 0)
			return ret;
	} else if (!strcmp(kcontrol->id.name, "ETDM_OUT2_Slave_Clock_Source")) {
		if (source == ETDM_OUT_SLAVE_FROM_PAD)
			value = COWORK_ETDM_OUT2_S;
		else if (source == ETDM_OUT_SLAVE_FROM_ETDM_IN1)
			value = COWORK_ETDM_IN1_M;
		else if (source == ETDM_OUT_SLAVE_FROM_ETDM_IN2)
			value = COWORK_ETDM_IN2_M;
		...
		val = ETDM_OUT2_SLAVE_SEL(value);
		regmap_update_bits(afe->regmap, reg, mask, val);

		ret = get_etdm_reg(MT8188_AFE_IO_ETDM2_OUT, &etdm_reg);
		if (ret < 0)
			return ret;
	} else
		return -EINVAL;
...
static int mt8188_etdmout_slv_clk_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (!strcmp(kcontrol->id.name, "ETDM_OUT1_Slave_Clock_Source")) {
		reg = ETDM_COWORK_CON0;
		mask = ETDM_OUT1_SLAVE_SEL_MASK;
		shift = ETDM_OUT1_SLAVE_SEL_SHIFT;
	} else if (!strcmp(kcontrol->id.name, "ETDM_OUT2_Slave_Clock_Source")) {
		reg = ETDM_COWORK_CON2;
		mask = ETDM_OUT2_SLAVE_SEL_MASK;
		shift = ETDM_OUT2_SLAVE_SEL_SHIFT;
	}
	...
	if (value == COWORK_ETDM_IN1_M)
		ucontrol->value.enumerated.item[0] =
			ETDM_OUT_SLAVE_FROM_ETDM_IN1;
	else if (value == COWORK_ETDM_IN2_M)
		ucontrol->value.enumerated.item[0] =
			ETDM_OUT_SLAVE_FROM_ETDM_IN2;
	else
		ucontrol->value.enumerated.item[0] =
...
static const struct snd_kcontrol_new mtk_dai_etdm_controls[] = {
	...
	SOC_ENUM_EXT("ETDM_IN1_Loopback_Source", etdmin_loopback_src_enum,
		     mt8188_etdmin_lpbk_src_get,
		     mt8188_etdmin_lpbk_src_put),
	SOC_ENUM_EXT("ETDM_IN2_Loopback_Source", etdmin_loopback_src_enum,
		     mt8188_etdmin_lpbk_src_get,
		     mt8188_etdmin_lpbk_src_put),

	SOC_ENUM_EXT("ETDM_IN1_Slave_Clock_Source", etdmin_slv_clk_enum,
		     mt8188_etdmin_slv_clk_get,
		     mt8188_etdmin_slv_clk_put),
	SOC_ENUM_EXT("ETDM_IN2_Slave_Clock_Source", etdmin_slv_clk_enum,
		     mt8188_etdmin_slv_clk_get,
		     mt8188_etdmin_slv_clk_put),

	SOC_ENUM_EXT("ETDM_OUT1_Slave_Clock_Source", etdmout_slv_clk_enum,
		     mt8188_etdmout_slv_clk_get,
		     mt8188_etdmout_slv_clk_put),
	SOC_ENUM_EXT("ETDM_OUT2_Slave_Clock_Source", etdmout_slv_clk_enum,
		     mt8188_etdmout_slv_clk_get,
		     mt8188_etdmout_slv_clk_put),
};
...
static const struct snd_soc_dapm_route mtk_dai_etdm_routes[] = {
	...
	{"O048", "I096 Switch", "I096"},
	{"O049", "I097 Switch", "I097"},
	{"O048", "I098 Switch", "I098"},
	{"O049", "I099 Switch", "I099"},
	{"O048", "I100 Switch", "I100"},
	{"O049", "I101 Switch", "I101"},
	{"O048", "I102 Switch", "I102"},
	{"O049", "I103 Switch", "I103"},
	{"O048", "I104 Switch", "I104"},
	{"O049", "I105 Switch", "I105"},
	{"O048", "I106 Switch", "I106"},
	{"O049", "I107 Switch", "I107"},
	{"O048", "I108 Switch", "I108"},
	{"O049", "I109 Switch", "I109"},
	{"O048", "I110 Switch", "I110"},
	{"O049", "I111 Switch", "I111"},
	{"O048", "I112 Switch", "I112"},
	{"O049", "I113 Switch", "I113"},
	{"O048", "I114 Switch", "I114"},
	{"O049", "I115 Switch", "I115"},
	{"O048", "I116 Switch", "I116"},
	{"O049", "I117 Switch", "I117"},
	{"O048", "I118 Switch", "I118"},
	{"O049", "I119 Switch", "I119"},

	{"O050", "I098 Switch", "I098"},
	{"O051", "I099 Switch", "I099"},
	{"O052", "I100 Switch", "I100"},
	{"O053", "I101 Switch", "I101"},
	{"O054", "I102 Switch", "I102"},
	{"O055", "I103 Switch", "I103"},
	{"O056", "I104 Switch", "I104"},
	{"O057", "I105 Switch", "I105"},
	{"O058", "I106 Switch", "I106"},
	{"O059", "I107 Switch", "I107"},
	{"O060", "I108 Switch", "I108"},
	{"O061", "I109 Switch", "I109"},
	{"O062", "I110 Switch", "I110"},
	{"O063", "I111 Switch", "I111"},
	...
	{"O072", "I096 Switch", "I096"},
	{"O073", "I097 Switch", "I097"},
	{"O072", "I098 Switch", "I098"},
	{"O073", "I099 Switch", "I099"},
	{"O072", "I100 Switch", "I100"},
	{"O073", "I101 Switch", "I101"},
	{"O072", "I102 Switch", "I102"},
	{"O073", "I103 Switch", "I103"},
	{"O072", "I104 Switch", "I104"},
	{"O073", "I105 Switch", "I105"},
	{"O072", "I106 Switch", "I106"},
	{"O073", "I107 Switch", "I107"},
	{"O072", "I108 Switch", "I108"},
	{"O073", "I109 Switch", "I109"},
	{"O072", "I110 Switch", "I110"},
	{"O073", "I111 Switch", "I111"},
	{"O072", "I112 Switch", "I112"},
	{"O073", "I113 Switch", "I113"},
	{"O072", "I114 Switch", "I114"},
	{"O073", "I115 Switch", "I115"},
	{"O072", "I116 Switch", "I116"},
	{"O073", "I117 Switch", "I117"},
	{"O072", "I118 Switch", "I118"},
	{"O073", "I119 Switch", "I119"},

	{"O074", "I098 Switch", "I098"},
	{"O075", "I099 Switch", "I099"},
	{"O076", "I100 Switch", "I100"},
	{"O077", "I101 Switch", "I101"},
	{"O078", "I102 Switch", "I102"},
	{"O079", "I103 Switch", "I103"},
	{"O080", "I104 Switch", "I104"},
	{"O081", "I105 Switch", "I105"},
	{"O082", "I106 Switch", "I106"},
	{"O083", "I107 Switch", "I107"},
	{"O084", "I108 Switch", "I108"},
	{"O085", "I109 Switch", "I109"},
	{"O086", "I110 Switch", "I110"},
	{"O087", "I111 Switch", "I111"},
				...
				struct snd_soc_dai *dai)
{
	...
	if (is_cowork_mode(dai)) {
		...
		if (mst_dai_id < MT8188_AFE_IO_ETDM_START ||
		    mst_dai_id >= MT8188_AFE_IO_ETDM_END)
			return -EINVAL;
				  ...
				  struct snd_soc_dai *dai)
{
	...
	if (dai->id < MT8188_AFE_IO_ETDM_START ||
	    dai->id >= MT8188_AFE_IO_ETDM_END) {
		dev_dbg(afe->dev, "%s(), invalid dai id\n", __func__);
		return;
	}
