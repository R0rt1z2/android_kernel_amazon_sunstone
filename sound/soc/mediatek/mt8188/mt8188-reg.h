...
#define AFE_SRAM_BASE                     (0x10b20000)
...
#define PCM_INTF_CON1_PCM_24BIT        (1 << 16)
#define PCM_INTF_CON1_PCM_16BIT        (0 << 16)
#define PCM_INTF_CON1_PCM_BIT_MASK     (1 << 16)
#define PCM_INTF_CON1_PCM_WLEN_32BCK   (0 << 14)
#define PCM_INTF_CON1_PCM_WLEN_64BCK   (1 << 14)
#define PCM_INTF_CON1_PCM_WLEN_MASK    (1 << 14)
#define PCM_INTF_CON1_SYNC_LENGTH(x)   ((x & 0x1f) << 9)
#define PCM_INTF_CON1_SYNC_LENGTH_MASK (0x1f << 9)
#define PCM_INTF_CON1_PCM_SLAVE        (1 << 5)
#define PCM_INTF_CON1_PCM_MASTER       (0 << 5)
#define PCM_INTF_CON1_PCM_M_S_MASK     (1 << 5)
...
#define AFE_GASRC_NEW_CON0_CHSET0_OFS_SEL_RX        (1 << 14)
