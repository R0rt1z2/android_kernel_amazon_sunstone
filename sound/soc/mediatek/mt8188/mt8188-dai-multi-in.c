...
#define DAI_TO_MULTI_IN_ID(x) (x - MT8188_AFE_IO_MULTI_IN_START)
...
static const struct mtk_dai_multi_in_mux multi_in_muxs[] = {
	{
		...
		.dai_id = MT8188_AFE_IO_MULTI_IN1,
	},
	{
		.name = "MULTI_IN2_MUX",
		.name_len = strlen("MULTI_IN2_MUX"),
		.dai_id = MT8188_AFE_IO_MULTI_IN2,
	},
};
...
static const struct snd_soc_dapm_widget mtk_dai_multi_in_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("MULTI_IN1_EN", AFE_MPHONE_MULTI_CON0,
			    0, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("MULTI_IN2_EN", AFE_MPHONE_MULTI2_CON0,
			    0, 0, NULL, 0),

	SND_SOC_DAPM_CLOCK_SUPPLY("aud_multi_in"),
};
...
static const struct snd_soc_dapm_route mtk_dai_multi_in_routes[] = {
	...
	{"MULTI1 Capture", NULL, "aud_multi_in"},

	{"MULTI2 Capture", NULL, "MULTI_IN2_EN"},
	{"MULTI2 Capture", NULL, "aud_multi_in"},
...
static const struct multi_in_con_reg
	multi_in_con_regs[MT8188_AFE_IO_MULTI_IN_NUM] = {
	{
...
static int mtk_dai_multi_in_fmt_config(struct snd_soc_dai *dai)
{
	...
	val |= AFE_MPHONE_MULTI_CON1_CH_NUM(channels) |
		AFE_MPHONE_MULTI_CON1_BIT_NUM(bit_width > 16 ? 24 : 16) |
...
enum {
	...
	MULTI_IN_SPLIN_BCK_SEL_ETDM_IN2_MASTER = 4,
...
enum {
	...
	MULTI_IN_SPLIN_LRCK_SEL_ETDM_IN2_MASTER = 4,
	MULTI_IN_SPLIN_LRCK_SEL_ETDM_OUT3_MASTER,
	MULTI_IN_SPLIN_LRCK_SEL_ETDM_OUT3_SDATA4 = 7,
};
...
/* MULTI_IN_SDATA_MUX */
enum {
	MULTI_IN_SDATA_MUX_SPLIN_SDATA0 = 0,
	MULTI_IN_SDATA_MUX_SPLIN_SDATA1,
	MULTI_IN_SDATA_MUX_SPLIN_SDATA2,
	MULTI_IN_SDATA_MUX_SPLIN_SDATA3,
	MULTI_IN_SDATA_MUX_SPLIN_LRCK,
	MULTI_IN_SDATA_MUX_SPLIN_SDATA5,
};
...
static const struct mtk_dai_multi_in_mux_reg
	multi_in_mux_regs[MT8188_AFE_IO_MULTI_IN_NUM][MULTI_IN_MUX_NUM] = {
	/* MULTI_IN1 */
	{
		[MULTI_IN_SPLIN_BCK_SEL] = {
...
static int mtk_dai_multi_in_mux_config(struct snd_soc_dai *dai)
{
	...
	unsigned int sdata0_mux = MULTI_IN_SDATA_MUX_SPLIN_SDATA0;
	unsigned int sdata1_mux = MULTI_IN_SDATA_MUX_SPLIN_SDATA1;
	unsigned int sdata2_mux = MULTI_IN_SDATA_MUX_SPLIN_SDATA2;
	unsigned int sdata3_mux = MULTI_IN_SDATA_MUX_SPLIN_SDATA3;
	unsigned int sdata4_mux = MULTI_IN_SDATA_MUX_SPLIN_LRCK;
	unsigned int sdata5_mux = MULTI_IN_SDATA_MUX_SPLIN_SDATA5;
...
static int init_multi_in_priv_data(struct mtk_base_afe *afe)
{
	...
	int i = MT8188_AFE_IO_MULTI_IN_START;

	for (; i < MT8188_AFE_IO_MULTI_IN_END; i++) {
