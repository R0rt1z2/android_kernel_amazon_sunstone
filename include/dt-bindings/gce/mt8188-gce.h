...
#define CMDQ_EVENT_VPP0_DISP_RDMA_0_UNDERRUN		336		//(FROM VDOSYS0)
#define CMDQ_EVENT_VPP0_DISP_RDMA_1_UNDERRUN		337		//(FROM VDOSYS0)
#define CMDQ_EVENT_VPP0_U_MERGE4_UNDERRUN 338				//(FROM VDOSYS1 )
#define CMDQ_EVENT_VPP0_U_VPP_SPLIT_VIDEO_0_OVERFLOW	339	//(FROM VPPSYS1)
#define CMDQ_EVENT_VPP0_U_VPP_SPLIT_VIDEO_1_OVERFLOW	340	//(FROM VPPSYS1)
#define CMDQ_EVENT_VPP0_DSI_0_UNDERRUN	341					//(FROM VDOSYS0)
#define CMDQ_EVENT_VPP0_DSI_1_UNDERRUN	342					//( FROM VDOSYS0)
#define CMDQ_EVENT_VPP0_DP_INTF_0 343		//(FOR EDP) ( FROM VDOSYS0)
#define CMDQ_EVENT_VPP0_DP_INTF_1 344		//(FOR DP )(FROM VDOSYS1)
#define CMDQ_EVENT_VPP0_DPI_0 345			//(FOR HDMI_TX)(FROM VDOSYS 1)
#define CMDQ_EVENT_VPP0_DPI_1 346		//(FOR DIGITAL VIDEO OUT)(FROM VDOSYS1)
...
#define CMDQ_EVENT_VDO0_DISP_RDMA_0_UNDERRUN		590		//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO0_DISP_RDMA_1_UNDERRUN		591		//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO0_U_MERGE4_UNDERRUN			592		//(FROM VDOSYS1)
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		593
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		594
#define CMDQ_EVENT_VDO0_DSI_0_UNDERRUN				595		//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO0_DSI_1_UNDERRUN				596		//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO0_DP_INTF_0	597			//(FOR EDP)(FROM VDOSYS0)
#define CMDQ_EVENT_VDO0_DP_INTF_1		598		//(FOR DP )(FROM VDOSYS1)
#define CMDQ_EVENT_VDO0_DPI_0			599		//(FOR HDMI_TX)(FROM VDOSYS 1)
#define CMDQ_EVENT_VDO0_DPI_1			600	//(FOR DIGITAL VIDEO OUT) (FROM VDOSYS1 )
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		601
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		602
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		603
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		604
//#define CMDQ_EVENT_VDO0_RESERVED FOR BUF_UNDERRUN_EVENT		605
...
#define CMDQ_EVENT_VDO0_RESERVED 639	//FOR  DISP_OVL1_O_FRAME_RESET_DONE_PULSE
...
#define CMDQ_EVENT_VDO1_DISP_RDMA_0_UNDERRUN	725			//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO1_DISP_RDMA_1_UNDERRUN 726			//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO1_U_MERGE4_UNDERRUN	727			//(FROM VDOSYS1)
#define CMDQ_EVENT_VDO1_U_VPP_SPLIT_VIDEO_0_OVERFLOW 728	//(FROM VPPSYS1)
#define CMDQ_EVENT_VDO1_U_VPP_SPLIT_VIDEO_1_OVERFLOW 729	//(FROM VPPSYS1)
#define CMDQ_EVENT_VDO1_DSI_0_UNDERRUN 730				//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO1_DSI_1_UNDERRUN 731				//(FROM VDOSYS0)
#define CMDQ_EVENT_VDO1_DP_INTF_0	732				//(FOR EDP)(FROM VDOSYS0)
#define CMDQ_EVENT_VDO1_DP_INTF_1	733				//(FOR DP )(FROM VDOSYS1)
#define CMDQ_EVENT_VDO1_DPI_0		734		//(FOR HDMI_TX)(FOR HDMI_TX)(FROM VDOSYS 1)
#define CMDQ_EVENT_VDO1_DPI_1		735		//(FOR DIGITAL VIDEO OUT) (FROM VDOSYS1)
//#define CMDQ_EVENT_RESERVED FOR BUF_UNDERRUN_EVENT	   736
//#define CMDQ_EVENT_RESERVED FOR BUF_UNDERRUN_EVENT	   737
//#define CMDQ_EVENT_RESERVED FOR BUF_UNDERRUN_EVENT	   738
//#define CMDQ_EVENT_RESERVED FOR BUF_UNDERRUN_EVENT	   739
//#define CMDQ_EVENT_RESERVED FOR BUF_UNDERRUN_EVENT	   740
...
//#define CMDQ_EVENT_RESERVED FOR DISP_RDMA1_O_DISP_RDMA_TARGET_LINE_EVENT	  912
//#define CMDQ_EVENT_RESERVED FOR DISP_WDMA1_O_WDMA_TARGET_LINE_EVENT	 913
//#define CMDQ_EVENT_RESERVED FOR DISP_WDMA1_O_SW_RST_DONE	  914
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_0	   915
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_1	   916
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_2	   917
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_3	   918
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_4	   919
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_5	   920
//#define CMDQ_EVENT_RESERVED FOR DISP_OVL1_O_TARGET_MATCH_EVENT_6	   921
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_LAST_SAFE_BLANK_EVENT_MM	  922
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_LAST_LINE_EVENT_MM		923
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_TRIGGER_LOOP_CLEAR_EVENT_MM	  924
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_TARGET_LINE_0_EVENT_MM		 925
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_TARGET_LINE_1_EVENT_MM		 926
//#define CMDQ_EVENT_RESERVED FOR DISP_DPI0_O_VSYNC_START_EVENT_MM	  927
