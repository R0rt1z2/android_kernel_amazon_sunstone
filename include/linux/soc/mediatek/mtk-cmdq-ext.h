...
typedef u16 (*util_get_platform_event_id)(u16 event_id);
...
struct cmdq_util_helper_fp {
	...
	util_get_platform_event_id get_platform_event_id;
...
enum gce_event {
	...
	/* GCE handshake event */
	CMDQ_EVENT_HANDSHAKE,

	/* GPR timer token (for gpr r0 to r15) */
	CMDQ_EVENT_GPR_TIMER,

	/* Keep this at the end of HW events */
	CMDQ_HW_EVENT_MAX,

	/* eof for cmdq secure thread */
	CMDQ_TOKEN_SECURE_THR_EOF,

	/* ATF PREBUILT sw token */
	CMDQ_TOKEN_PREBUILT_MDP_WAIT,
	CMDQ_TOKEN_PREBUILT_MDP_SET,
	CMDQ_TOKEN_PREBUILT_MDP_LOCK,
	CMDQ_TOKEN_PREBUILT_MML_WAIT,
	CMDQ_TOKEN_PREBUILT_MML_SET,
	CMDQ_TOKEN_PREBUILT_MML_LOCK,
	CMDQ_TOKEN_PREBUILT_VFMT_WAIT,
	CMDQ_TOKEN_PREBUILT_VFMT_SET,
	CMDQ_TOKEN_PREBUILT_VFMT_LOCK,
	CMDQ_TOKEN_PREBUILT_DISP_WAIT,
	CMDQ_TOKEN_PREBUILT_DISP_SET,
	CMDQ_TOKEN_PREBUILT_DISP_LOCK,
	CMDQ_TOKEN_DISP_VA_START,
	CMDQ_TOKEN_DISP_VA_END,

	/* Pass-2 notifies VENC frame is ready to be encoded */
	CMDQ_TOKEN_VENC_INPUT_READY,
	 ...
	 */
	CMDQ_TOKEN_GPR_SET_0,
	CMDQ_TOKEN_GPR_SET_1,
	CMDQ_TOKEN_GPR_SET_2,
	CMDQ_TOKEN_GPR_SET_3,
	CMDQ_TOKEN_GPR_SET_4,

	/* Resource lock event to control resource in GCE thread */
	CMDQ_TOKEN_RESOURCE_WROT0,
	CMDQ_TOKEN_RESOURCE_WROT1,

	/* event id is 10 bit */
	CMDQ_TOKEN_MAX = CMDQ_EVENT_MAX,
	CMDQ_TOKEN_INVALID = -1,
};
