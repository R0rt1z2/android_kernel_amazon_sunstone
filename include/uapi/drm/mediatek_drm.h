...
/* ETHDR */
#define DRM_MTK_ETHDR_SET_METADATA        0x40
#define DRM_MTK_ETHDR_SET_HDR_ON_OFF      0x41

/* HDMI */
#define DRM_MTK_HDMI_ENABLE               0x50

/* DP */
#define DRM_MTK_DP_ENABLE                 0x55
...
enum MTK_ETHDR_HDR_TYPE {
	MTK_ETHDR_HDR_TYPE_SDR = 0,
	MTK_ETHDR_HDR_TYPE_HDR10,
	MTK_ETHDR_HDR_TYPE_HLG,
	MTK_ETHDR_HDR_TYPE_HDR10PLUS,
	MTK_ETHDR_HDR_TYPE_DV,
	MTK_ETHDR_HDR_TYPE_MAX
};

enum MTK_ETHDR_COLOR_RANGE {
	MTK_ETHDR_COLOR_RANGE_LIMIT = 0,
	MTK_ETHDR_COLOR_RANGE_FULL,
	MTK_ETHDR_COLOR_RANGE_MAX
};

enum MTK_ETHDR_ON_OFF_STATUS {
	MTK_ETHDR_HDROFF_DVOFF = 0,
	MTK_ETHDR_HDRON_DVOFF,
	MTK_ETHDR_HDRON_DVON,
};

struct mtk_ethdr_hdr10_static_metadata {
...
struct mtk_ethdr_hdr10plus_dynamic_metadata {
...
struct mtk_ethdr_metadata {
	unsigned int planeId;
	enum MTK_ETHDR_HDR_TYPE hdrType;
	struct mtk_ethdr_hdr10_static_metadata hdr10StaticMetadata;
	struct mtk_ethdr_hdr10plus_dynamic_metadata hdr10PlusDynamicMetadata;
	...
	enum MTK_ETHDR_COLOR_RANGE colorRange;
};
...
#define DRM_IOCTL_MTK_ETHDR_SET_METADATA     DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_MTK_ETHDR_SET_METADATA, struct mtk_ethdr_metadata)

#define DRM_IOCTL_MTK_ETHDR_SET_HDR_ON_OFF     DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_MTK_ETHDR_SET_HDR_ON_OFF, enum MTK_ETHDR_ON_OFF_STATUS)

#define DRM_IOCTL_MTK_HDMI_ENABLE DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_MTK_HDMI_ENABLE, struct mtk_hdmi_enable)

#define DRM_IOCTL_MTK_DP_ENABLE DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_MTK_DP_ENABLE, struct mtk_dp_enable)
